        ...
        easyResponsiveTabs: function(l) {
            ...
            p(this).on("bind", "tabactivate", function(t, e) {
                ...
                n.find("ul.resp-tabs-list." + l.tabidentify + " li").addClass("resp-tab-item").addClass(l.tabidentify), n.css({
                    display: "block",
                    width: h
                }), "vertical" == l.type && n.find(".resp-tabs-container." + l.tabidentify).css("border-color", l.active_content_border_color), n.find(".resp-tabs-container." + l.tabidentify + " > div").addClass("resp-tab-content").addClass(l.tabidentify), "vertical" == c && n.addClass("resp-vtabs").addClass(l.tabidentify), 1 == u && n.css({
                    width: "100%",
                    margin: "0px"
                }), "accordion" == c && (n.addClass("resp-easy-accordion").addClass(l.tabidentify), n.find(".resp-tabs-list").css("display", "none")), n.find(".resp-tab-content." + l.tabidentify).before("<h2 class='resp-accordion " + l.tabidentify + "' role='tab'><span class='resp-arrow'></span></h2>"), n.find(".resp-tab-content." + l.tabidentify).prev("h2").css({
                ...
                n.find(".resp-accordion").each(function() {
                    i = p(this);
                    var t = n.find(".resp-tab-item:eq(" + s + ")"),
                        e = n.find(".resp-accordion:eq(" + s + ")");
                ...
                var r, a = 0;
                "" == d || null !== (r = d.match(new RegExp(o + "([0-9]+)"))) && 2 === r.length && (a = parseInt(r[1], 10) - 1, e < a && (a = 0)), p(n.find(".resp-tab-item." + l.tabidentify)[a]).addClass("resp-tab-active").css({
                    "background-color": l.activetab_bg,
                    "border-color": l.active_border_color
                }), !0 === l.closed || "accordion" === l.closed && !t.is(":visible") || "tabs" === l.closed && t.is(":visible") || (p(n.find(".resp-accordion." + l.tabidentify)[a]).addClass("resp-tab-active").css({
                    "background-color": l.activetab_bg + " !important",
                    "border-color": l.active_border_color,
                    background: "none"
                }), p(n.find(".resp-tab-content." + l.tabidentify)[a]).addClass("resp-tab-content-active").addClass(l.tabidentify).attr("style", "display:block")), n.find("[role=tab]").each(function() {
...
function(u, e) {
    ...
    i.Defaults = {
        ...
        this._playing || (this._core.enter("playing"), this._core.trigger("play", null, "video"), e = this._core.items(this._core.relative(e.index())), this._core.reset(e.index()), (t = u('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", o), t.attr("width", n), "youtube" === i.type ? t.attr("src", "//www.youtube.com/embed/" + i.id + "?autoplay=1&rel=0&v=" + i.id) : "vimeo" === i.type ? t.attr("src", "//player.vimeo.com/video/" + i.id + "?autoplay=1") : "vzaar" === i.type && t.attr("src", "//view.vzaar.com/" + i.id + "/player?autoplay=true"), u(t).wrap('<div class="owl-video-frame" />').insertAfter(e.find(".owl-video")), this._playing = e.addClass("owl-video-playing"))
...
function(o, s) {
    ...
    function c(t) {
        ...
        return !!l("transition")
    }() || (o.support.transition = new String(c("transition")), o.support.transition.end = t.transition.end[o.support.transition]), n() && (o.support.animation = new String(c("animation")), o.support.animation.end = t.animation.end[o.support.animation]), e() && (o.support.transform = new String(c("transform")), o.support.transform3d = i())
    ...
    i.fn.counterUp = function(t) {
        ...
        return this.each(function() {
            var l = i(this),
                c = e;
            l.waypoint(function() {
                for (var t = [], e = c.time / c.delay, i = l.text(), n = /[0-9]+,[0-9]+/.test(i), i = i.replace(/,/g, ""), o = (/^[0-9]+$/.test(i), /^[0-9]+\.[0-9]+$/.test(i)), s = o ? (i.split(".")[1] || []).length : 0, r = e; 1 <= r; r--) {
...
function(p, o, t, g) {
    ...
    function c(t, e) {
        this.element = t, this.options = p.extend({}, i, e), this._defaults = i, this._name = n, this.init()
    }
    c.prototype = {
        init: function() {
        ...
        _defineElements: function() {
            this.element === t.body && (this.element = o), this.$scrollElement = p(this.element), this.$element = this.element === o ? p("body") : this.$scrollElement, this.$viewportElement = this.options.viewportElement !== g ? p(this.options.viewportElement) : this.$scrollElement[0] === o || "scroll" === this.options.scrollProperty ? this.$scrollElement : this.$scrollElement.parent()
        },
        ...
        _defineSetters: function() {
            ...
            this._setScrollLeft = "function" == typeof e ? function(t) {
                e(s.$scrollElement, t)
            } : p.noop, this._setScrollTop = "function" == typeof i ? function(t) {
                i(s.$scrollElement, t)
            } : p.noop, this._setPosition = r.setPosition || function(t, e, i, n, o) {
        ...
        refresh: function(t) {
            var i = this,
                e = i._getScrollLeft(),
                n = i._getScrollTop();
            t && t.firstLoad || this._reset(), this._setScrollLeft(0), this._setScrollTop(0), this._setOffsets(), this._findParticles(), this._findBackgrounds(), t && t.firstLoad && /WebKit/.test(navigator.userAgent) && p(o).on("load", function() {
        ...
        _findParticles: function() {
            ...
            this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function(t) {
                ...
                f.options.showElement(l), l.data("stellar-startingLeft") ? (l.css("left", l.data("stellar-startingLeft")), l.css("top", l.data("stellar-startingTop"))) : (l.data("stellar-startingLeft", l.css("left")), l.data("stellar-startingTop", l.css("top"))), e = l.position().left, i = l.position().top, n = "auto" === l.css("margin-left") ? 0 : parseInt(l.css("margin-left"), 10), o = "auto" === l.css("margin-top") ? 0 : parseInt(l.css("margin-top"), 10), r = l.offset().left - n, a = l.offset().top - o, l.parents().each(function() {
                    var t = p(this);
                    if (!0 === t.data("stellar-offset-parent")) return c = h, u = d, s = t, !1;
                    h += t.position().left, d += t.position().top
                }), n = l.data("stellar-horizontal-offset") !== g ? l.data("stellar-horizontal-offset") : s !== g && s.data("stellar-horizontal-offset") !== g ? s.data("stellar-horizontal-offset") : f.horizontalOffset, o = l.data("stellar-vertical-offset") !== g ? l.data("stellar-vertical-offset") : s !== g && s.data("stellar-vertical-offset") !== g ? s.data("stellar-vertical-offset") : f.verticalOffset, f.particles.push({
                    $element: l,
                    $offsetParent: s,
        ...
        _findBackgrounds: function() {
            ...
            this.backgrounds = [], this.options.parallaxBackgrounds && (t = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (t = t.add(this.$element)), t.each(function() {
                ...
                s.data("stellar-backgroundStartingLeft") ? m(s, s.data("stellar-backgroundStartingLeft"), s.data("stellar-backgroundStartingTop")) : (s.data("stellar-backgroundStartingLeft", r[0]), s.data("stellar-backgroundStartingTop", r[1])), t = "auto" === s.css("margin-left") ? 0 : parseInt(s.css("margin-left"), 10), e = "auto" === s.css("margin-top") ? 0 : parseInt(s.css("margin-top"), 10), i = s.offset().left - t - d, n = s.offset().top - e - f, s.parents().each(function() {
                    var t = p(this);
                    if (!0 === t.data("stellar-offset-parent")) return a = c, l = u, o = t, !1;
                    c += t.position().left, u += t.position().top
                }), t = s.data("stellar-horizontal-offset") !== g ? s.data("stellar-horizontal-offset") : o !== g && o.data("stellar-horizontal-offset") !== g ? o.data("stellar-horizontal-offset") : h.horizontalOffset, e = s.data("stellar-vertical-offset") !== g ? s.data("stellar-vertical-offset") : o !== g && o.data("stellar-vertical-offset") !== g ? o.data("stellar-vertical-offset") : h.verticalOffset, h.backgrounds.push({
                    $element: s,
                    $offsetParent: o,
        ...
        _reset: function() {
            ...
            for (o = this.backgrounds.length - 1; 0 <= o; o--)(n = this.backgrounds[o]).$element.data("stellar-backgroundStartingLeft", null).data("stellar-backgroundStartingTop", null), m(n.$element, n.startingValueLeft, n.startingValueTop)
        },
        destroy: function() {
            this._reset(), this.$scrollElement.unbind("resize." + this.name).unbind("scroll." + this.name), this._animationLoop = p.noop, p(o).unbind("load." + this.name).unbind("resize." + this.name)
        },
        ...
        _repositionElements: function() {
            var t, e, i, n, o, s, r, a, l, c, u = this._getScrollLeft(),
        ...
        return e === g || "object" == typeof e ? this.each(function() {
            p.data(this, "plugin_" + n) || p.data(this, "plugin_" + n, new c(this, e))
        }) : "string" == typeof e && "_" !== e[0] && "init" !== e ? this.each(function() {
            var t = p.data(this, "plugin_" + n);
            t instanceof c && "function" == typeof t[e] && t[e].apply(t, Array.prototype.slice.call(i, 1)), "destroy" === e && p.data(this, "plugin_" + n, null)
        }) : void 0
    }, p[n] = function(t) {
        var e = p(o);
        return e.stellar.apply(e, Array.prototype.slice.call(arguments, 0))
    }, p[n].scrollProperty = a, p[n].positionProperty = l, o.Stellar = c
...
function() {
    ...
    function i(t) {
        this.element = t, this.Adapter = f.Adapter, this.adapter = new this.Adapter(t), this.key = "waypoint-context-" + n, this.didScroll = !1, this.didResize = !1, this.oldScroll = {
            ...
            vertical: {},
            horizontal: {}
        }, t.waypointContextKey = this.key, o[t.waypointContextKey] = this, n += 1, f.windowContext || (f.windowContext = !0, f.windowContext = new i(window)), this.createThrottledScrollHandler(), this.createThrottledResizeHandler()
    }
    var n = 0,
        o = {},
        f = window.Waypoint,
...
function(c) {
    ...
    c.fn.countdown = function(t, s) {
        ...
        function e() {
            ...
            i -= 60 * o * 60;
            e = Math.floor(i / 60);
            i -= 60 * e, 1 == n ? r.find(".timeRefDays").text("day") : r.find(".timeRefDays").text("days"), 1 == o ? r.find(".timeRefHours").text("hour") : r.find(".timeRefHours").text("hours"), 1 == e ? r.find(".timeRefMinutes").text("minute") : r.find(".timeRefMinutes").text("minutes"), 1 == i ? r.find(".timeRefSeconds").text("second") : r.find(".timeRefSeconds").text("seconds"), "on" == a.format && (n = 2 <= String(n).length ? n : "0" + n, o = 2 <= String(o).length ? o : "0" + o, e = 2 <= String(e).length ? e : "0" + e, i = 2 <= String(i).length ? i : "0" + i), isNaN(t) ? (alert("Invalid date. Here's an example: 12 Tuesday 2012 17:30:00"), clearInterval(l)) : (r.find(".days").text(n), r.find(".hours").text(o), r.find(".minutes").text(e), r.find(".seconds").text(i))
        }
        t && c.extend(a, t), e();
...
function(t) {
    ...
    function d(t, e) {
        p.ev.triggerHandler("mfp" + t, e), p.st.callbacks && (t = t.charAt(0).toLowerCase() + t.slice(1), p.st.callbacks[t] && p.st.callbacks[t].apply(p, c.isArray(e) ? e : [e]))
    }
    ...
    t.prototype = {
        ...
        init: function() {
            ...
            p.isLowIE = p.isIE8 = document.all && !document.addEventListener, p.isAndroid = /android/gi.test(t), p.isIOS = /iphone|ipad|ipod/gi.test(t), p.supportsTransition = function() {
                ...
                return !1
            }(), p.probablyMobile = p.isAndroid || p.isIOS || /(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent), g = c(document), p.popupsCache = {}
        },
        open: function(t) {
            if (!1 === t.isObj) {
            ...
            if (!p.isOpen) {
                p.types = [], m = "", t.mainEl && t.mainEl.length ? p.ev = t.mainEl.eq(0) : p.ev = g, t.key ? (p.popupsCache[t.key] || (p.popupsCache[t.key] = {}), p.currTemplate = p.popupsCache[t.key]) : p.currTemplate = {}, p.st = c.extend(!0, {}, c.magnificPopup.defaults, t), p.fixedContentPos = "auto" === p.st.fixedContentPos ? !p.probablyMobile : p.st.fixedContentPos, p.st.modal && (p.st.closeOnContentClick = !1, p.st.closeOnBgClick = !1, p.st.showCloseBtn = !1, p.st.enableEscapeKey = !1), p.bgOverlay || (p.bgOverlay = h("bg").on("click" + x, function() {
                    p.close()
                }), p.wrap = h("wrap").attr("tabindex", -1).on("click" + x, function(t) {
                    p._checkIfClose(t.target) && p.close()
                }), p.container = h("container", p.wrap)), p.contentContainer = h("content"), p.st.preloader && (p.preloader = h("preloader", p.container, p.st.tLoading));
                var o = c.magnificPopup.modules;
                for (n = 0; n < o.length; n++) {
                    var s = (s = o[n]).charAt(0).toUpperCase() + s.slice(1);
                    p["init" + s].call(p)
                }
                d("BeforeOpen"), p.st.showCloseBtn && (p.st.closeBtnInside ? (u(v, function(t, e, i, n) {
                    i.close_replaceWith = f(n.type)
                }), m += " mfp-close-btn-in") : p.wrap.append(f())), p.st.alignTop && (m += " mfp-align-top"), p.fixedContentPos ? p.wrap.css({
                    ...
                    height: g.height(),
                    position: "absolute"
                }), p.st.enableEscapeKey && g.on("keyup" + x, function(t) {
                    27 === t.keyCode && p.close()
                }), _.on("resize" + x, function() {
                    p.updateSize()
                }), p.st.closeOnContentClick || (m += " mfp-auto-cursor"), m && p.wrap.addClass(m);
                var r = p.wH = _.height(),
                    a = {};
                p.fixedContentPos && p._hasScrollBar(r) && ((l = p._getScrollbarSize()) && (a.marginRight = l)), p.fixedContentPos && (p.isIE7 ? c("body, html").css("overflow", "hidden") : a.overflow = "hidden");
                var l = p.st.mainClass;
                return p.isIE7 && (l += " mfp-ie7"), l && p._addClassToMFP(l), p.updateItemHTML(), d("BuildControls"), c("html").css(a), p.bgOverlay.add(p.wrap).prependTo(p.st.prependTo || c(document.body)), p._lastFocusedEl = document.activeElement, setTimeout(function() {
                    p.content ? (p._addClassToMFP(w), p._setFocus()) : p.bgOverlay.addClass(w), g.on("focusin" + x, p._onFocusIn)
                }, 16), p.isOpen = !0, p.updateSize(r), d(b), t
            }
            p.updateItemHTML()
        },
        close: function() {
            p.isOpen && (d(y), p.isOpen = !1, p.st.removalDelay && !p.isLowIE && p.supportsTransition ? (p._addClassToMFP(i), setTimeout(function() {
                p._close()
        ...
        _close: function() {
            ...
            p.bgOverlay.detach(), p.wrap.detach(), p.container.empty(), p.st.mainClass && (t += p.st.mainClass + " "), p._removeClassFromMFP(t), p.fixedContentPos && (t = {
                marginRight: ""
            }, p.isIE7 ? c("body, html").css("overflow", "") : t.overflow = "", c("html").css(t)), g.off("keyup.mfp focusin" + x), p.ev.off(x), p.wrap.attr("class", "mfp-wrap").removeAttr("style"), p.bgOverlay.attr("class", "mfp-bg"), p.container.attr("class", "mfp-container"), !p.st.showCloseBtn || p.st.closeBtnInside && !0 !== p.currTemplate[p.currItem.type] || p.currTemplate.closeBtn && p.currTemplate.closeBtn.detach(), p.st.autoFocusLast && p._lastFocusedEl && c(p._lastFocusedEl).focus(), p.currItem = null, p.content = null, p.currTemplate = null, p.prevHeight = 0, d("AfterClose")
        },
        updateSize: function(t) {
            var e;
            p.isIOS ? (e = document.documentElement.clientWidth / window.innerWidth, e = window.innerHeight * e, p.wrap.css("height", e), p.wH = e) : p.wH = t || _.height(), p.fixedContentPos || p.wrap.css("height", p.wH), d("Resize")
        },
        updateItemHTML: function() {
            var t = p.items[p.index];
            p.contentContainer.detach(), p.content && p.content.detach(), t.parsed || (t = p.parseEl(p.index));
            var e = t.type;
            d("BeforeChange", [p.currItem ? p.currItem.type : "", e]), p.currItem = t, p.currTemplate[e] || (i = !!p.st[e] && p.st[e].markup, d("FirstMarkupParse", i), p.currTemplate[e] = !i || c(i)), o && o !== t.type && p.container.removeClass("mfp-" + o + "-holder");
            var i = p["get" + e.charAt(0).toUpperCase() + e.slice(1)](t, p.currTemplate[e]);
            p.appendContent(i, e), t.preloaded = !0, d("Change", t), o = t.type, p.container.prepend(p.contentContainer), d("AfterChange")
        },
        appendContent: function(t, e) {
            (p.content = t) ? p.st.showCloseBtn && p.st.closeBtnInside && !0 === p.currTemplate[e] ? p.content.find(".mfp-close").length || p.content.append(f()) : p.content = t: p.content = "", d("BeforeAppend"), p.container.addClass("mfp-" + e + "-holder"), p.contentContainer.append(p.content)
        },
        parseEl: function(t) {
            var e, i = p.items[t];
            if ((i = i.tagName ? {
            ...
            return i.type = e || p.st.type || "inline", i.index = t, i.parsed = !0, p.items[t] = i, d("ElementParse", i), p.items[t]
        },
        ...
        updateStatus: function(t, e) {
            var i;
            p.preloader && (n !== t && p.container.removeClass("mfp-s-" + n), e || "loading" !== t || (e = p.st.tLoading), d("UpdateStatus", i = {
                status: t,
                text: e
            }), t = i.status, e = i.text, p.preloader.html(e), p.preloader.find("a").on("click", function(t) {
                t.stopImmediatePropagation()
            }), p.container.addClass("mfp-s-" + t), n = t)
        },
        ...
        _hasScrollBar: function(t) {
            return (p.isIE7 ? g.height() : document.body.scrollHeight) > (t || _.height())
        },
        _setFocus: function() {
        ...
        _parseMarkup: function(o, t, e) {
            ...
            e.data && (t = c.extend(e.data, t)), d(v, [o, t, e]), c.each(t, function(t, e) {
                return void 0 === e || !1 === e || void(1 < (s = t.split("_")).length ? 0 < (i = o.find(x + "-" + s[0])).length && ("replaceWith" === (n = s[1]) ? i[0] !== e[0] && i.replaceWith(e) : "img" === n ? i.is("img") ? i.attr("src", e) : i.replaceWith(c("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(s[1], e)) : o.find(x + "-" + t).html(e));
                var i, n
            })
        },
        ...
        s();
        var e, i, n, o = c(this);
        return "string" == typeof t ? "open" === t ? (e = a ? o.data("magnificPopup") : o[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, n = e.items ? e.items[i] : (n = o, e.delegate && (n = n.find(e.delegate)), n.eq(i)), p._openClick({
            mfpEl: n
        }, o, e)) : p.isOpen && p[t].apply(p, Array.prototype.slice.call(arguments, 1)) : (t = c.extend(!0, {}, t), a ? o.data("magnificPopup", t) : o[0].magnificPopup = t, p.addGroup(o, t)), o
    };

    function k() {
        T && (S.after(T.addClass(C)).detach(), T = null)
    }
    var C, S, T, M = "inline";
        ...
        proto: {
            ...
            getInline: function(t, e) {
                if (k(), t.src) {
                    var i, n = p.st.inline,
                        o = c(t.src);
                    return o.length ? ((i = o[0].parentNode) && i.tagName && (S || (C = n.hiddenClass, S = h(C), C = "mfp-" + C), T = o.after(S).detach().removeClass(C)), p.updateStatus("ready")) : (p.updateStatus("error", n.tNotFound), o = c("<div>")), t.inlineElement = o
                }
    ...
    c.magnificPopup.registerModule(z, {
        ...
        proto: {
            initAjax: function() {
                p.types.push(z), P = p.st.ajax.cursor, u(l + "." + z, A), u("BeforeChange." + z, A)
            },
            getAjax: function(n) {
                ...
                var t = c.extend({
                    ...
                    success: function(t, e, i) {
                        ...
                        d("ParseAjax", i), p.appendContent(c(i.data), z), n.finished = !0, I(), p._setFocus(), setTimeout(function() {
                            p.wrap.addClass(w)
                        }, 16), p.updateStatus("ready"), d("AjaxContentAdded")
                    },
                    error: function() {
                        I(), n.finished = n.loadError = !0, p.updateStatus("error", p.st.ajax.tError.replace("%url%", n.src))
                    }
                }, p.st.ajax.settings);
    ...
    c.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var t = p.st.image,
                    e = ".image";
                p.types.push("image"), u(b + e, function() {
                    "image" === p.currItem.type && t.cursor && c(document.body).addClass(t.cursor)
                }), u(l + e, function() {
                    t.cursor && c(document.body).removeClass(t.cursor), _.off("resize" + x)
                }), u("Resize" + e, p.resizeImage), p.isLowIE && u("AfterChange", p.resizeImage)
            },
            ...
            _onImageHasSize: function(t) {
                t.img && (t.hasSize = !0, D && clearInterval(D), t.isCheckingImgSize = !1, d("ImageHasSize", t), t.imgHidden && (p.content && p.content.removeClass("mfp-loading"), t.imgHidden = !1))
            },
                ...
                var i = 0,
                    ...
                    o = function(t) {
                        D && clearInterval(D), D = setInterval(function() {
                            return 0 < n.naturalWidth ? void p._onImageHasSize(e) : (200 < i && clearInterval(D), void(3 === ++i ? o(10) : 40 === i ? o(50) : 100 === i && o(500)))
                        }, t)
                    };
                o(1)
            },
            getImage: function(t, e) {
                var i, n = 0,
                    o = function() {
                        t && (t.img[0].complete ? (t.img.off(".mfploader"), t === p.currItem && (p._onImageHasSize(t), p.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, d("ImageLoadComplete")) : ++n < 200 ? setTimeout(o, 100) : s())
                    },
                    s = function() {
                    ...
                    r = p.st.image,
                    a = e.find(".mfp-img");
                return a.length && ((i = document.createElement("img")).className = "mfp-img", t.el && t.el.find("img").length && (i.alt = t.el.find("img").attr("alt")), t.img = c(i).on("load.mfploader", o).on("error.mfploader", s), i.src = t.src, a.is("img") && (t.img = t.img.clone()), 0 < (i = t.img[0]).naturalWidth ? t.hasSize = !0 : i.width || (t.hasSize = !1)), p._parseMarkup(e, {
                    title: function(t) {
                ...
                }, t), p.resizeImage(), t.hasSize ? (D && clearInterval(D), t.loadError ? (e.addClass("mfp-loading"), p.updateStatus("error", r.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), p.updateStatus("ready"))) : (p.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, e.addClass("mfp-loading"), p.findImageSize(t))), e
            }
        }
    });
    var E;
    c.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                var t, e, i, n, o, s, r = p.st.zoom,
                    a = ".zoom";
                r.enabled && p.supportsTransition && (n = r.duration, o = function(t) {
                    ...
                    p._allowZoom() && (clearTimeout(e), p.content.css("visibility", "hidden"), (t = p._getItemToZoom()) ? ((i = o(t)).css(p._getOffset()), p.wrap.append(i), e = setTimeout(function() {
                        i.css(p._getOffset(!0)), e = setTimeout(function() {
                    ...
                    if (p._allowZoom()) {
                        if (clearTimeout(e), p.st.removalDelay = n, !t) {
            ...
            _getOffset: function(t) {
                ...
                return void 0 === E && (E = void 0 !== document.createElement("p").style.MozTransform), E ? n["-moz-transform"] = n.transform = "translate(" + i.left + "px," + i.top + "px)" : (n.left = i.left, n.top = i.top), n
            }
        }
    });
    ...
    function O(t) {
        var e;
        !p.currTemplate[$] || (e = p.currTemplate[$].find("iframe")).length && (t || (e[0].src = "//about:blank"), p.isIE8 && e.css("display", t ? "block" : "none"))
    }
    var $ = "iframe";
    c.magnificPopup.registerModule($, {
        ...
        proto: {
            initIframe: function() {
                p.types.push($), u("BeforeChange", function(t, e, i) {
                    e !== i && (e === $ ? O() : i === $ && O(!0))
                }), u(l + "." + $, function() {
                    O()
                })
    ...
    c.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var s = p.st.gallery,
                    t = ".mfp-gallery";
                return p.direction = !0, !(!s || !s.enabled) && (m += " mfp-gallery", u(b + t, function() {
                    ...
                    e.text && (e.text = L(e.text, p.currItem.index, p.items.length))
                }), u(v + t, function(t, e, i, n) {
                    var o = p.items.length;
                    i.counter = 1 < o ? L(s.tCounter, n.index, o) : ""
                }), u("BuildControls" + t, function() {
                    var t, e;
                    1 < p.items.length && s.arrows && !p.arrowLeft && (e = s.arrowMarkup, t = p.arrowLeft = c(e.replace(/%title%/gi, s.tPrev).replace(/%dir%/gi, "left")).addClass(r), e = p.arrowRight = c(e.replace(/%title%/gi, s.tNext).replace(/%dir%/gi, "right")).addClass(r), t.click(function() {
                        p.prev()
                    }), e.click(function() {
                        p.next()
                    ...
                    g.off(t), p.wrap.off("click" + t), p.arrowRight = p.arrowLeft = null
                }))
            },
            next: function() {
            ...
            preloadNearbyImages: function() {
                for (var t = p.st.gallery.preload, e = Math.min(t[0], p.items.length), i = Math.min(t[1], p.items.length), n = 1; n <= (p.direction ? i : e); n++) p._preloadItem(p.index + n);
                for (n = 1; n <= (p.direction ? e : i); n++) p._preloadItem(p.index - n)
            },
            _preloadItem: function(t) {
                var e;
                t = F(t), p.items[t].preloaded || ((e = p.items[t]).parsed || (e = p.parseEl(t)), d("LazyLoad", e), "image" === e.type && (e.img = c('<img class="mfp-img" />').on("load.mfploader", function() {
                    e.hasSize = !0
    ...
    c.magnificPopup.registerModule(R, {
        ...
        proto: {
            initRetina: function() {
                var i, n;
                1 < window.devicePixelRatio && (i = p.st.retina, n = i.ratio, 1 < (n = isNaN(n) ? n() : n) && (u("ImageHasSize." + R, function(t, e) {
                    e.img.css({
...
function(e, i) {
    ...
    function i(l, c, u) {
        (u = u || e || t.jQuery) && (c.prototype.option || (c.prototype.option = function(t) {
            ...
            var n, o, s, r, a, e = h.call(arguments, 1);
            return o = e, r = "$()." + l + '("' + (n = t) + '")', (t = this).each(function(t, e) {
                var i = u.data(e, l);
                i ? (e = i[n]) && "_" != n.charAt(0) ? (i = e.apply(i, o), s = void 0 === s ? i : s) : d(r + " is not a valid method") : d(l + " not initialized. Cannot call methods, i.e. " + r)
            }), void 0 !== s ? s : t
        }, n(u))
    }
...
function(t, e) {
    ...
    function g(t) {
        if (b || (b = !0, (d = document.createElement("div")).style.width = "200px", d.style.padding = "1px 2px 3px 4px", d.style.borderStyle = "solid", d.style.borderWidth = "1px 2px 3px 4px", d.style.boxSizing = "border-box", (h = document.body || document.documentElement).appendChild(d), u = p(d), g.isBoxSizeOuter = m = 200 == f(u.width), h.removeChild(d)), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
            var e = p(t);
            ...
            n = f(e.height);
            return !1 !== n && (i.height = n + (t ? 0 : l + d)), i.innerWidth = i.width - (a + h), i.innerHeight = i.height - (l + d), i.outerWidth = i.width + c, i.outerHeight = i.height + u, i
        }
        var d, h, u
    }
...
function(t, e) {
    ...
    t.constructor = i, t._create = function() {
        ...
        var i = this.position.x,
            ...
            o = parseInt(t, 10),
            s = parseInt(e, 10),
            s = o === this.position.x && s === this.position.y;
        this.setPosition(t, e), !s || this.isTransitioning ? (i = t - i, e -= n, (n = {}).transform = this.getTranslate(i, e), this.transition({
            to: n,
            onTransitionEnd: {
    ...
    return function n(o, s, r) {
        ...
        2: [function(t, e, i) {
            ...
            function o(t) {
                if (t) {
                    ...
                    if (e) {
                        t = parseFloat(e[4]);
                        return [c(parseInt(e[1]), 0, 360), c(parseFloat(e[2]), 0, 100), c(parseFloat(e[3]), 0, 100), c(isNaN(t) ? 1 : t, 0, 1)]
                    }
                }
            }
            ...
            e.exports = {
                ...
                getHsla: o,
                getRgb: function(t) {
                    return (t = n(t)) && t.slice(0, 3)
                },
                getHsl: function(t) {
                    return (t = o(t)) && t.slice(0, 3)
                },
                getHwb: s,
                getAlpha: function(t) {
                    var e = n(t);
                    return (e = e || o(t)) || (e = s(t)) ? e[3] : void 0
                },
                ...
                percentString: function(t, e) {
                    return e < 1 || t[3] && t[3] < 1 ? a(t, e) : "rgb(" + Math.round(t[0] / 255 * 100) + "%, " + Math.round(t[1] / 255 * 100) + "%, " + Math.round(t[2] / 255 * 100) + "%)"
                },
                percentaString: a,
            ...
            r.prototype = {
                ...
                clone: function() {
                    var t, e, i, n = new r,
                        o = this.values,
                        s = n.values;
                    for (i in o) o.hasOwnProperty(i) && (t = o[i], e = {}.toString.call(t), "[object Array]" === e ? s[i] = t.slice(0) : "[object Number]" === e ? s[i] = t : console.error("unexpected color value:", t));
                    return n
                }
            }, r.prototype.spaces = {
                rgb: ["red", "green", "blue"],
                ...
                if ("alpha" === t) a = e;
                    ...
                    for (var l = s[t], c = 0; c < t.length; c++) o[t][c] = e[l[c]];
                    a = e.alpha
                }
                if (o.alpha = Math.max(0, Math.min(1, void 0 === a ? o.alpha : a)), "alpha" === t) return !1;
                for (c = 0; c < t.length; c++) i = Math.max(0, Math.min(r[t][c], o[t][c])), o[t][c] = Math.round(i);
                for (n in s) n !== t && (o[n] = u[t][n](o[t]));
                return !0
        ...
        4: [function(t, e, i) {
            function o(t) {
                var e, i = t[0] / 255,
                    ...
                    r = Math.max(i, n, o),
                    t = r - s;
                return r == s ? e = 0 : i == r ? e = (n - o) / t : n == r ? e = 2 + (o - i) / t : o == r && (e = 4 + (i - n) / t), (e = Math.min(60 * e, 360)) < 0 && (e += 360), n = (s + r) / 2, [e, 100 * (r == s ? 0 : n <= .5 ? t / (r + s) : t / (2 - r - s)), 100 * n]
            }
            ...
            function n(t) {
                var e, i = t[0],
                    ...
                    a = r - s,
                    t = 0 == r ? 0 : a / r * 1e3 / 10;
                return r == s ? e = 0 : i == r ? e = (n - o) / a : n == r ? e = 2 + (o - i) / a : o == r && (e = 4 + (i - n) / a), (e = Math.min(60 * e, 360)) < 0 && (e += 360), [e, t, r / 255 * 1e3 / 10]
            }
            ...
            function h(t) {
                var e, i, n, o, s, r = t[0] / 360,
                    a = t[1] / 100,
                    t = t[2] / 100;
                if (0 == a) return [s = 255 * t, s, s];
                e = 2 * t - (i = t < .5 ? t * (1 + a) : t + a - t * a), o = [0, 0, 0];
                for (var l = 0; l < 3; l++)(n = r + 1 / 3 * -(l - 1)) < 0 && n++, 1 < n && n--, s = 6 * n < 1 ? e + 6 * (i - e) * n : 2 * n < 1 ? i : 3 * n < 2 ? e + (i - e) * (2 / 3 - n) * 6 : e, o[l] = 255 * s;
                return o
            }
            ...
            function f(t) {
                var e, i, n = t[0] / 360,
                    ...
                    s = t[2] / 100,
                    t = o + s;
                switch (1 < t && (o /= t, s /= t), n = 6 * n - (t = Math.floor(6 * n)), 0 != (1 & t) && (n = 1 - n), i = o + n * ((e = 1 - s) - o), t) {
                    default:
                        case 6:
                        case 0:
                        r = e,
            ...
            function m(t) {
                var e = t[0] / 100,
                    ...
                    t = -.9689 * e + 1.8758 * i + .0415 * n,
                    n = .0557 * e + -.204 * i + 1.057 * n;
                return o = .0031308 < o ? 1.055 * Math.pow(o, 1 / 2.4) - .055 : o *= 12.92, t = .0031308 < t ? 1.055 * Math.pow(t, 1 / 2.4) - .055 : t *= 12.92, n = .0031308 < n ? 1.055 * Math.pow(n, 1 / 2.4) - .055 : n *= 12.92, [255 * (o = Math.min(Math.max(0, o), 1)), 255 * (t = Math.min(Math.max(0, t), 1)), 255 * (n = Math.min(Math.max(0, n), 1))]
            }
            ...
            function v(t) {
                var e, i = t[0],
                    ...
                    o = o / 95.047 <= .008856 ? o = 95.047 * (n / 500 + i - 16 / 116) / 7.787 : 95.047 * Math.pow(n / 500 + i, 3),
                    s = s / 108.883 <= .008859 ? s = 108.883 * (i - t / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(i - t / 200, 3);
                return [o, e, s]
            }
            ...
            function x(t) {
                var e = t[0],
                    i = t[1],
                    n = t[2],
                    t = 360 * Math.atan2(n, i) / 2 / Math.PI;
            ...
            e.exports = {
                ...
                hsl2hsv: function(t) {
                    var e = t[0],
                        i = t[1] / 100;
                    return 0 == (t = t[2] / 100) ? [0, 0, 0] : [e, 100 * (2 * (i *= (t *= 2) <= 1 ? t : 2 - t) / (t + i)), 100 * ((t + i) / 2)]
                },
                hsl2hwb: function(t) {
                    return s(h(t))
                },
                ...
                hsv2hsl: function(t) {
                    var e = t[0],
                        ...
                        t = (2 - i) * n,
                        n = i * n;
                    return [e, 100 * ((n /= t <= 1 ? t : 2 - t) || 0), 100 * (t /= 2)]
                },
                hsv2hwb: function(t) {
                    return s(d(t))
                },
            ...
            var C, S = {
                ...
                T = {};
            for (C in S) T[JSON.stringify(S[C])] = C
        }, {}],
        5: [function(t, e, i) {
            function o() {
                return new l
            ...
            e.exports = function(l) {
                ...
                l.defaults.bar = {
                    ...
                    initialize: function(t, e) {
                        ...
                        t = this.getMeta(), e = this.getDataset();
                        t.stack = e.stack, t.bar = !0
                    },
                    getStackCount: function() {
                        var n = this,
                            ...
                            s = [];
                        return u.each(n.chart.data.datasets, function(t, e) {
                            var i = n.chart.getDatasetMeta(e);
                            i.bar && n.chart.isDatasetVisible(e) && (!1 === o.options.stacked || !0 === o.options.stacked && -1 === s.indexOf(i.stack) || void 0 === o.options.stacked && (void 0 === i.stack || -1 === s.indexOf(i.stack))) && s.push(i.stack)
                        }, n), s.length
                    },
                    update: function(i) {
                        var n = this;
                        u.each(n.getMeta().data, function(t, e) {
                    ...
                    updateElement: function(t, e, i) {
                        var n = this,
                            ...
                            c = t.custom || {},
                            o = n.getDataset();
                        t._xScale = s, t._yScale = r, t._datasetIndex = n.index, t._index = e;
                        r = n.getRuler(e);
                        t._model = {
                            x: n.calculateBarX(e, n.index, r),
                            y: i ? a : n.calculateBarY(e, n.index),
                            label: n.chart.data.labels[e],
                            datasetLabel: o.label,
                            horizontal: !1,
                            base: i ? a : n.calculateBarBase(n.index, e),
                            width: n.calculateBarWidth(r),
                            backgroundColor: c.backgroundColor || u.getValueAtIndexOrDefault(o.backgroundColor, e, l.backgroundColor),
                            borderSkipped: c.borderSkipped || l.borderSkipped,
                            borderColor: c.borderColor || u.getValueAtIndexOrDefault(o.borderColor, e, l.borderColor),
                            borderWidth: c.borderWidth || u.getValueAtIndexOrDefault(o.borderWidth, e, l.borderWidth)
                        }, t.pivot()
                    },
                    calculateBarBase: function(t, e) {
                        ...
                        if (!0 === n.options.stacked || void 0 === n.options.stacked && void 0 !== i.stack) {
                            for (var r = this.chart, a = r.data.datasets, l = Number(a[t].data[e]), c = 0; c < t; c++) {
                                var u = a[c],
                                    h = r.getDatasetMeta(c);
                                h.bar && h.yAxisID === n.id && r.isDatasetVisible(c) && i.stack === h.stack && (u = Number(u.data[e]), o += l < 0 ? Math.min(u, s) : Math.max(u, s))
                            }
                    ...
                    getRuler: function() {
                        ...
                        return {
                            ...
                            fullBarWidth: t,
                            barWidth: t * e.options.barPercentage,
                            barSpacing: t - t * e.options.barPercentage
                        }
                    },
                    calculateBarWidth: function(t) {
                        var e = this.getMeta(),
                            e = this.getScaleForId(e.xAxisID);
                        return e.options.barThickness || t.barWidth
                    },
                    getStackIndex: function(t) {
                        for (var e, i = this.chart.getDatasetMeta(t), n = this.getScaleForId(i.yAxisID), o = [i.stack], s = 0; s < t; ++s)(e = this.chart.getDatasetMeta(s)).bar && this.chart.isDatasetVisible(s) && (!1 === n.options.stacked || !0 === n.options.stacked && -1 === o.indexOf(e.stack) || void 0 === n.options.stacked && (void 0 === e.stack || -1 === o.indexOf(e.stack))) && o.push(e.stack);
                        return o.length - 1
                    },
                    calculateBarX: function(t, e, i) {
                        var n = this,
                            ...
                            s = n.getScaleForId(o.xAxisID),
                            o = n.getStackIndex(e),
                            e = s.getPixelForValue(null, t, e, n.chart.isCombo);
                        return (e -= n.chart.isCombo ? i.tickWidth / 2 : 0) + i.barWidth / 2 + i.categorySpacing + i.barWidth * o + i.barSpacing / 2 + i.barSpacing * o
                    },
                    calculateBarY: function(t, e) {
                        ...
                        if (o.options.stacked || void 0 === o.options.stacked && void 0 !== n.stack) {
                            for (var r = o.getBaseValue(), a = r, l = r, c = 0; c < e; c++) {
                                var u = i.chart.data.datasets[c],
                                    h = i.chart.getDatasetMeta(c);
                                h.bar && h.yAxisID === o.id && i.chart.isDatasetVisible(c) && n.stack === h.stack && ((u = Number(u.data[t])) < 0 ? l += u || 0 : a += u || 0)
                            }
                            return s < 0 ? o.getPixelForValue(l + s) : o.getPixelForValue(a + s)
                        }
                        return o.getPixelForValue(s)
                    },
                    draw: function(t) {
                        var e, i, n = this,
                            o = t || 1,
                            s = n.getMeta().data,
                            r = n.getDataset();
                        for (l.canvasHelpers.clipArea(n.chart.chart.ctx, n.chart.chartArea), e = 0, i = s.length; e < i; ++e) {
                            var a = r.data[e];
                            null == a || isNaN(a) || s[e].transition(o).draw()
                        }
                        l.canvasHelpers.unclipArea(n.chart.chart.ctx)
                    },
                    setHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex],
                            ...
                            n = t.custom || {},
                            t = t._model;
                        t.backgroundColor = n.hoverBackgroundColor || u.getValueAtIndexOrDefault(e.hoverBackgroundColor, i, u.getHoverColor(t.backgroundColor)), t.borderColor = n.hoverBorderColor || u.getValueAtIndexOrDefault(e.hoverBorderColor, i, u.getHoverColor(t.borderColor)), t.borderWidth = n.hoverBorderWidth || u.getValueAtIndexOrDefault(e.hoverBorderWidth, i, t.borderWidth)
                    },
                    removeHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex],
                            ...
                            n = t.custom || {},
                            o = t._model,
                            t = this.chart.options.elements.rectangle;
                        o.backgroundColor = n.backgroundColor || u.getValueAtIndexOrDefault(e.backgroundColor, i, t.backgroundColor), o.borderColor = n.borderColor || u.getValueAtIndexOrDefault(e.borderColor, i, t.borderColor), o.borderWidth = n.borderWidth || u.getValueAtIndexOrDefault(e.borderWidth, i, t.borderWidth)
                    }
                    ...
                    updateElement: function(t, e, i) {
                        var n = this,
                            ...
                            l = t.custom || {},
                            c = n.getDataset(),
                            o = n.chart.options.elements.rectangle;
                        t._xScale = s, t._yScale = r, t._datasetIndex = n.index, t._index = e;
                        r = n.getRuler(e);
                        t._model = {
                            x: i ? a : n.calculateBarX(e, n.index),
                            y: n.calculateBarY(e, n.index, r),
                            label: n.chart.data.labels[e],
                            datasetLabel: c.label,
                            horizontal: !0,
                            base: i ? a : n.calculateBarBase(n.index, e),
                            height: n.calculateBarHeight(r),
                            backgroundColor: l.backgroundColor || u.getValueAtIndexOrDefault(c.backgroundColor, e, o.backgroundColor),
                            borderSkipped: l.borderSkipped || o.borderSkipped,
                            borderColor: l.borderColor || u.getValueAtIndexOrDefault(c.borderColor, e, o.borderColor),
                            borderWidth: l.borderWidth || u.getValueAtIndexOrDefault(c.borderWidth, e, o.borderWidth)
                        }, t.pivot()
                    },
                    calculateBarBase: function(t, e) {
                        var i = this.getMeta(),
                        ...
                        if (n.options.stacked || void 0 === n.options.stacked && void 0 !== i.stack) {
                            for (var r = this.chart, a = r.data.datasets, l = Number(a[t].data[e]), c = 0; c < t; c++) {
                                var u = a[c],
                                    h = r.getDatasetMeta(c);
                                h.bar && h.xAxisID === n.id && r.isDatasetVisible(c) && i.stack === h.stack && (u = Number(u.data[e]), o += l < 0 ? Math.min(u, s) : Math.max(u, s))
                            }
                            return n.getPixelForValue(o)
                        }
                        return n.getBasePixel()
                    ...
                    getRuler: function() {
                        ...
                        return {
                            ...
                            categorySpacing: (n - n * e.options.categoryPercentage) / 2,
                            fullBarHeight: t,
                            barHeight: t * e.options.barPercentage,
                            barSpacing: t - t * e.options.barPercentage
                        }
                    },
                    calculateBarHeight: function(t) {
                        ...
                        return e.options.barThickness || t.barHeight
                    },
                    getStackIndex: function(t) {
                        for (var e, i = this.chart.getDatasetMeta(t), n = this.getScaleForId(i.xAxisID), o = [i.stack], s = 0; s < t; ++s)(e = this.chart.getDatasetMeta(s)).bar && this.chart.isDatasetVisible(s) && (!1 === n.options.stacked || !0 === n.options.stacked && -1 === o.indexOf(e.stack) || void 0 === n.options.stacked && (void 0 === e.stack || -1 === o.indexOf(e.stack))) && o.push(e.stack);
                        return o.length - 1
                    },
                    calculateBarX: function(t, e) {
                        ...
                        if (o.options.stacked || void 0 === o.options.stacked && void 0 !== n.stack) {
                            for (var r = o.getBaseValue(), a = r, l = r, c = 0; c < e; c++) {
                                var u = i.chart.data.datasets[c],
                                    h = i.chart.getDatasetMeta(c);
                                h.bar && h.xAxisID === o.id && i.chart.isDatasetVisible(c) && n.stack === h.stack && ((u = Number(u.data[t])) < 0 ? l += u || 0 : a += u || 0)
                            }
                            return s < 0 ? o.getPixelForValue(l + s) : o.getPixelForValue(a + s)
                        }
                        return o.getPixelForValue(s)
                    ...
                    calculateBarY: function(t, e, i) {
                        var n = this,
                            ...
                            o = n.getStackIndex(e),
                            e = s.getPixelForValue(null, t, e, n.chart.isCombo);
                        return (e -= n.chart.isCombo ? i.tickHeight / 2 : 0) + i.barHeight / 2 + i.categorySpacing + i.barHeight * o + i.barSpacing / 2 + i.barSpacing * o
                    }
                })
            }
        }, {}],
                ...
                h.defaults.bubble = {
                    ...
                    updateElement: function(t, e, i) {
                        ...
                        d.extend(t, {
                            ...
                            _index: e,
                            _model: {
                                x: i ? s.getPixelForDecimal(.5) : s.getPixelForValue("object" == typeof c ? c : NaN, e, o, n.chart.isCombo),
                                y: i ? r.getBasePixel() : r.getPixelForValue(c, e, o),
                                radius: i ? 0 : a.radius || n.getRadius(c),
                                hitRadius: a.hitRadius || d.getValueAtIndexOrDefault(l.hitRadius, e, u.hitRadius)
                            }
                        }), h.DatasetController.prototype.removeHoverStyle.call(n, t, u);
                        u = t._model;
                        u.skip = a.skip || isNaN(u.x) || isNaN(u.y), t.pivot()
                    },
                    getRadius: function(t) {
                        return t.r || this.chart.options.elements.point.radius
                    },
                    setHoverStyle: function(t) {
                        h.DatasetController.prototype.setHoverStyle.call(this, t);
                        var e = this.chart.data.datasets[t._datasetIndex],
                            i = t._index,
                            n = t.custom || {};
                        t._model.radius = n.hoverRadius || d.getValueAtIndexOrDefault(e.hoverRadius, i, this.chart.options.elements.point.hoverRadius) + this.getRadius(e.data[i])
                    },
                    removeHoverStyle: function(t) {
                        h.DatasetController.prototype.removeHoverStyle.call(this, t, this.chart.options.elements.point);
                        var e = this.chart.data.datasets[t._datasetIndex].data[t._index],
                            i = t.custom || {};
                        t._model.radius = i.radius || this.getRadius(e)
                    }
                })
            }
        }, {}],
                ...
                t.doughnut = {
                    ...
                    legend: {
                            ...
                            generateLabels: function(a) {
                                ...
                                return l.labels.length && l.datasets.length ? l.labels.map(function(t, e) {
                                    var i = a.getDatasetMeta(0),
                                        ...
                                        o = i.data[e],
                                        s = o && o.custom || {},
                                        r = v.getValueAtIndexOrDefault,
                                        o = a.options.elements.arc;
                                    return {
                                        text: t,
                                        fillStyle: s.backgroundColor || r(n.backgroundColor, e, o.backgroundColor),
                                        strokeStyle: s.borderColor || r(n.borderColor, e, o.borderColor),
                                        lineWidth: s.borderWidth || r(n.borderWidth, e, o.borderWidth),
                        ...
                        onClick: function(t, e) {
                            for (var i, n = e.index, o = this.chart, s = 0, r = (o.data.datasets || []).length; s < r; ++s)(i = o.getDatasetMeta(s)).data[n] && (i.data[n].hidden = !i.data[n].hidden);
                            o.update()
                        }
                    },
                    cutoutPercentage: 50,
                        ...
                        callbacks: {
                            ...
                            label: function(t, e) {
                                var i = e.labels[t.index],
                                    t = ": " + e.datasets[t.datasetIndex].data[t.index];
                                return v.isArray(i) ? (i = i.slice())[0] += t : i += t, i
                            }
                        }
                    }
                }, t.pie = v.clone(t.doughnut), v.extend(t.pie, {
                    cutoutPercentage: 0
                    ...
                    update: function(i) {
                        var t, e, n, o, s, r = this,
                            a = r.chart,
                            l = a.chartArea,
                            c = a.options,
                            u = c.elements.arc,
                            h = l.right - l.left - u.borderWidth,
                            d = l.bottom - l.top - u.borderWidth,
                            f = Math.min(h, d),
                            p = {
                                x: 0,
                                y: 0
                    ...
                    updateElement: function(t, e, i) {
                        var n = this,
                            ...
                            h = r.rotation,
                            d = n.getDataset(),
                            f = i && a.animateRotate || t.hidden ? 0 : n.calculateCircumference(d.data[e]) * (r.circumference / (2 * Math.PI)),
                            p = i && a.animateScale ? 0 : n.innerRadius,
                            g = i && a.animateScale ? 0 : n.outerRadius,
                            s = v.getValueAtIndexOrDefault;
                        v.extend(t, {
                            ...
                            _model: {
                                ...
                                outerRadius: g,
                                innerRadius: p,
                                label: s(d.label, e, o.data.labels[e])
                            }
                        });
                        o = t._model;
                        this.removeHoverStyle(t), i && a.animateRotate || (o.startAngle = 0 === e ? r.rotation : n.getMeta().data[e - 1]._model.endAngle, o.endAngle = o.startAngle + o.circumference), t.pivot()
                    },
                    removeHoverStyle: function(t) {
                    ...
                    calculateTotal: function() {
                        var i, n = this.getDataset(),
                            t = this.getMeta(),
                            o = 0;
                        return v.each(t.data, function(t, e) {
                    ...
                    getMaxBorderWidth: function(t) {
                        for (var e, i = 0, n = this.index, o = t.length, s = 0; s < o; s++) i = (i = i < (e = t[s]._model ? t[s]._model.borderWidth : 0) ? e : i) < (e = t[s]._chart ? t[s]._chart.config.data.datasets[n].hoverBorderWidth : 0) ? e : i;
                        return i
                    }
                })
            }
        ...
        18: [function(t, e, i) {
            ...
            e.exports = function(a) {
                function d(t, e) {
                    return f.getValueOrDefault(t.showLine, e.showLines)
                }
                var f = a.helpers;
                a.defaults.line = {
                    showLines: !0,
                    ...
                    update: function(t) {
                        var e, i, n = this,
                            ...
                            a = n.chart.options,
                            l = a.elements.line,
                            c = n.getScaleForId(o.yAxisID),
                            u = n.getDataset(),
                            h = d(u, a);
                        for (h && (o = s.custom || {}, void 0 !== u.tension && void 0 === u.lineTension && (u.lineTension = u.tension), s._scale = c, s._datasetIndex = n.index, s._children = r, s._model = {
                                spanGaps: u.spanGaps || a.spanGaps,
                                tension: o.tension || f.getValueOrDefault(u.lineTension, l.tension),
                                backgroundColor: o.backgroundColor || u.backgroundColor || l.backgroundColor,
                                borderWidth: o.borderWidth || u.borderWidth || l.borderWidth,
                                borderColor: o.borderColor || u.borderColor || l.borderColor,
                                borderCapStyle: o.borderCapStyle || u.borderCapStyle || l.borderCapStyle,
                                borderDash: o.borderDash || u.borderDash || l.borderDash,
                                borderDashOffset: o.borderDashOffset || u.borderDashOffset || l.borderDashOffset,
                                borderJoinStyle: o.borderJoinStyle || u.borderJoinStyle || l.borderJoinStyle,
                                fill: o.fill || (void 0 !== u.fill ? u : l).fill,
                                steppedLine: o.steppedLine || f.getValueOrDefault(u.steppedLine, l.stepped),
                                cubicInterpolationMode: o.cubicInterpolationMode || f.getValueOrDefault(u.cubicInterpolationMode, l.cubicInterpolationMode),
                                scaleTop: c.top,
                                scaleBottom: c.bottom,
                                scaleZero: c.getBasePixel()
                            }, s.pivot()), e = 0, i = r.length; e < i; ++e) n.updateElement(r[e], e, t);
                        for (h && 0 !== s._model.tension && n.updateBezierControlPoints(), e = 0, i = r.length; e < i; ++e) r[e].pivot()
                    },
                    getPointBackgroundColor: function(t, e) {
                        var i = this.chart.options.elements.point.backgroundColor,
                            n = this.getDataset(),
                            t = t.custom || {};
                        return t.backgroundColor ? i = t.backgroundColor : n.pointBackgroundColor ? i = f.getValueAtIndexOrDefault(n.pointBackgroundColor, e, i) : n.backgroundColor && (i = n.backgroundColor), i
                    },
                    getPointBorderColor: function(t, e) {
                        var i = this.chart.options.elements.point.borderColor,
                            n = this.getDataset(),
                            t = t.custom || {};
                        return t.borderColor ? i = t.borderColor : n.pointBorderColor ? i = f.getValueAtIndexOrDefault(n.pointBorderColor, e, i) : n.borderColor && (i = n.borderColor), i
                    },
                    getPointBorderWidth: function(t, e) {
                        var i = this.chart.options.elements.point.borderWidth,
                            n = this.getDataset(),
                            t = t.custom || {};
                        return isNaN(t.borderWidth) ? isNaN(n.pointBorderWidth) ? isNaN(n.borderWidth) || (i = n.borderWidth) : i = f.getValueAtIndexOrDefault(n.pointBorderWidth, e, i) : i = t.borderWidth, i
                    },
                    updateElement: function(t, e, i) {
                        var n = this,
                            o = n.getMeta(),
                            ...
                            h = n.chart.options.elements.point,
                            d = 1 === (n.chart.data.labels || []).length || 1 === r.data.length || n.chart.isCombo;
                        void 0 !== r.radius && void 0 === r.pointRadius && (r.pointRadius = r.radius), void 0 !== r.hitRadius && void 0 === r.pointHitRadius && (r.pointHitRadius = r.hitRadius), d = u.getPixelForValue("object" == typeof l ? l : NaN, e, a, d), l = i ? c.getBasePixel() : n.calculatePointY(l, e, a), t._xScale = u, t._yScale = c, t._datasetIndex = a, t._index = e, t._model = {
                            x: d,
                            y: l,
                            skip: s.skip || isNaN(d) || isNaN(l),
                            radius: s.radius || f.getValueAtIndexOrDefault(r.pointRadius, e, h.radius),
                            pointStyle: s.pointStyle || f.getValueAtIndexOrDefault(r.pointStyle, e, h.pointStyle),
                            backgroundColor: n.getPointBackgroundColor(t, e),
                            borderColor: n.getPointBorderColor(t, e),
                            borderWidth: n.getPointBorderWidth(t, e),
                            tension: o.dataset._model ? o.dataset._model.tension : 0,
                            steppedLine: !!o.dataset._model && o.dataset._model.steppedLine,
                            hitRadius: s.hitRadius || f.getValueAtIndexOrDefault(r.pointHitRadius, e, h.hitRadius)
                        }
                    },
                    calculatePointY: function(t, e, i) {
                        ...
                        if (r.options.stacked) {
                            for (n = 0; n < i; n++) {
                                var c, u = o.data.datasets[n];
                                "line" === (c = o.getDatasetMeta(n)).type && c.yAxisID === r.id && o.isDatasetVisible(n) && ((u = Number(r.getRightValue(u.data[e]))) < 0 ? l += u || 0 : a += u || 0)
                            }
                            s = Number(r.getRightValue(t));
                            return s < 0 ? r.getPixelForValue(l + s) : r.getPixelForValue(a + s)
                        }
                    ...
                    updateBezierControlPoints: function() {
                        ...
                        var e, i, n, o, s = this.getMeta(),
                            r = this.chart.chartArea,
                            a = s.data || [];
                        if (s.dataset._model.spanGaps && (a = a.filter(function(t) {
                                return !t._model.skip
                            })), "monotone" === s.dataset._model.cubicInterpolationMode) f.splineCurveMonotone(a);
                        else
                            for (e = 0, i = a.length; e < i; ++e) n = a[e]._model, o = f.splineCurve(f.previousItem(a, e)._model, n, f.nextItem(a, e)._model, s.dataset._model.tension), n.controlPointPreviousX = o.previous.x, n.controlPointPreviousY = o.previous.y, n.controlPointNextX = o.next.x, n.controlPointNextY = o.next.y;
                        if (this.chart.options.elements.line.capBezierPoints)
                            for (e = 0, i = a.length; e < i; ++e)(n = a[e]._model).controlPointPreviousX = t(n.controlPointPreviousX, r.left, r.right), n.controlPointPreviousY = t(n.controlPointPreviousY, r.top, r.bottom), n.controlPointNextX = t(n.controlPointNextX, r.left, r.right), n.controlPointNextY = t(n.controlPointNextY, r.top, r.bottom)
                    },
                    draw: function(t) {
                        for (var e = this, i = e.getMeta(), n = i.data || [], o = t || 1, s = 0, r = n.length; s < r; ++s) n[s].transition(o);
                        for (a.canvasHelpers.clipArea(e.chart.chart.ctx, e.chart.chartArea), d(e.getDataset(), e.chart.options) && i.dataset.transition(o).draw(), a.canvasHelpers.unclipArea(e.chart.chart.ctx), s = 0, r = n.length; s < r; ++s) n[s].draw(e.chart.chartArea)
                    },
                    setHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex],
                            i = t._index,
                    ...
                    removeHoverStyle: function(t) {
                        var e = this,
                            ...
                            o = t.custom || {},
                            s = t._model;
                        void 0 !== i.radius && void 0 === i.pointRadius && (i.pointRadius = i.radius), s.radius = o.radius || f.getValueAtIndexOrDefault(i.pointRadius, n, e.chart.options.elements.point.radius), s.backgroundColor = e.getPointBackgroundColor(t, n), s.borderColor = e.getPointBorderColor(t, n), s.borderWidth = e.getPointBorderWidth(t, n)
                    }
                })
            }
        }, {}],
            ...
            e.exports = function(e) {
                ...
                e.defaults.polarArea = {
                    ...
                    legend: {
                            ...
                            generateLabels: function(a) {
                                ...
                                return l.labels.length && l.datasets.length ? l.labels.map(function(t, e) {
                                    var i = a.getDatasetMeta(0),
                                        n = l.datasets[0],
                                        o = i.data[e].custom || {},
                                        s = b.getValueAtIndexOrDefault,
                                        r = a.options.elements.arc;
                                    return {
                                        text: t,
                                        fillStyle: o.backgroundColor || s(n.backgroundColor, e, r.backgroundColor),
                                        strokeStyle: o.borderColor || s(n.borderColor, e, r.borderColor),
                                        lineWidth: o.borderWidth || s(n.borderWidth, e, r.borderWidth),
                                        hidden: isNaN(n.data[e]) || i.data[e].hidden,
                                        index: e
                                    }
                                }) : []
                        ...
                        onClick: function(t, e) {
                            for (var i, n = e.index, o = this.chart, s = 0, r = (o.data.datasets || []).length; s < r; ++s)(i = o.getDatasetMeta(s)).data[n].hidden = !i.data[n].hidden;
                            o.update()
                        }
                    },
                    tooltips: {
                    ...
                    update: function(i) {
                        ...
                        t.outerRadius = Math.max((e - r.borderWidth / 2) / 2, 0), t.innerRadius = Math.max(s.cutoutPercentage ? t.outerRadius / 100 * s.cutoutPercentage : 1, 0), t.radiusLength = (t.outerRadius - t.innerRadius) / t.getVisibleDatasetCount(), n.outerRadius = t.outerRadius - t.radiusLength * n.index, n.innerRadius = n.outerRadius - t.radiusLength, o.count = n.countVisibleElements(), b.each(o.data, function(t, e) {
                            n.updateElement(t, e, i)
                        })
                    },
                    updateElement: function(t, e, i) {
                        for (var n = this, o = n.chart, s = n.getDataset(), r = o.options, a = r.animation, l = o.scale, c = b.getValueAtIndexOrDefault, u = o.data.labels, h = n.calculateCircumference(s.data[e]), d = l.xCenter, f = l.yCenter, p = 0, g = n.getMeta(), m = 0; m < e; ++m) isNaN(s.data[m]) || g.data[m].hidden || ++p;
                        var y = r.startAngle,
                            v = t.hidden ? 0 : l.getDistanceFromCenterForValue(s.data[e]),
                            o = y + h * p,
                            r = o + (t.hidden ? 0 : h),
                            h = a.animateScale ? 0 : l.getDistanceFromCenterForValue(s.data[e]);
                        b.extend(t, {
                            _datasetIndex: n.index,
                            _index: e,
                            _scale: l,
                            _model: {
                                ...
                                innerRadius: 0,
                                outerRadius: i ? h : v,
                                startAngle: i && a.animateRotate ? y : o,
                                endAngle: i && a.animateRotate ? y : r,
                                label: c(u, e, u[e])
                            }
                ...
                t.defaults.radar = {
                    ...
                    update: function(i) {
                        var n = this,
                            ...
                            s = e.custom || {},
                            r = n.getDataset(),
                            a = n.chart.options.elements.line,
                            e = n.chart.scale;
                        void 0 !== r.tension && void 0 === r.lineTension && (r.lineTension = r.tension), c.extend(t.dataset, {
                            ...
                            _loop: !0,
                            _model: {
                                tension: s.tension || c.getValueOrDefault(r.lineTension, a.tension),
                                backgroundColor: s.backgroundColor || r.backgroundColor || a.backgroundColor,
                                borderWidth: s.borderWidth || r.borderWidth || a.borderWidth,
                                borderColor: s.borderColor || r.borderColor || a.borderColor,
                                fill: s.fill || (void 0 !== r.fill ? r : a).fill,
                                borderCapStyle: s.borderCapStyle || r.borderCapStyle || a.borderCapStyle,
                                borderDash: s.borderDash || r.borderDash || a.borderDash,
                                borderDashOffset: s.borderDashOffset || r.borderDashOffset || a.borderDashOffset,
                                borderJoinStyle: s.borderJoinStyle || r.borderJoinStyle || a.borderJoinStyle,
                                scaleTop: e.top,
                                scaleBottom: e.bottom,
                                scaleZero: e.getBasePosition()
                            }
                    ...
                    updateElement: function(t, e, i) {
                        ...
                        c.extend(t, {
                            ...
                            _model: {
                                x: i ? r.xCenter : l.x,
                                y: i ? r.yCenter : l.y,
                                tension: o.tension || c.getValueOrDefault(s.lineTension, n.chart.options.elements.line.tension),
                                radius: o.radius || c.getValueAtIndexOrDefault(s.pointRadius, e, a.radius),
                                backgroundColor: o.backgroundColor || c.getValueAtIndexOrDefault(s.pointBackgroundColor, e, a.backgroundColor),
                                borderColor: o.borderColor || c.getValueAtIndexOrDefault(s.pointBorderColor, e, a.borderColor),
                                borderWidth: o.borderWidth || c.getValueAtIndexOrDefault(s.pointBorderWidth, e, a.borderWidth),
                                pointStyle: o.pointStyle || c.getValueAtIndexOrDefault(s.pointStyle, e, a.pointStyle),
                                hitRadius: o.hitRadius || c.getValueAtIndexOrDefault(s.hitRadius, e, a.hitRadius)
                            }
                    ...
                    updateBezierControlPoints: function() {
                        var n = this.chart.chartArea,
                            o = this.getMeta();
                        c.each(o.data, function(t, e) {
                            var i = t._model,
                                e = c.splineCurve(c.previousItem(o.data, e, !0)._model, i, c.nextItem(o.data, e, !0)._model, i.tension);
            ...
            e.exports = function(t) {
                ...
                t.defaults.global.animation = {
                    ...
                    addAnimation: function(t, e, i, n) {
                        var o = this;
                        n || (t.animating = !0);
                        for (var s = 0; s < o.animations.length; ++s)
                            if (o.animations[s].chartInstance === t) return void(o.animations[s].animationObject = e);
                        o.animations.push({
                            chartInstance: t,
                            animationObject: e
                    ...
                    startDigest: function() {
                        ...
                        e = (Date.now() - e) / t.frameDuration;
                        t.dropFrames += e, 0 < t.animations.length && t.requestAnimationFrame()
                    }
                }
            }
        }, {}],
                    ...
                    if ("object" != typeof e || "[object HTMLImageElement]" !== (s = e.toString()) && "[object HTMLCanvasElement]" !== s) {
                        if (!(isNaN(i) || i <= 0)) {
                            switch (e) {
                                ...
                                case "triangle":
                                        t.beginPath(),
                                    h = (u = 3 * i / Math.sqrt(3)) * Math.sqrt(3) / 2,
                                    t.moveTo(n - u / 2, o + h / 3),
                                    t.lineTo(n + u / 2, o + h / 3),
                                    t.lineTo(n, o - 2 * h / 3),
                                    t.closePath(),
                                    t.fill();
                                    break;
                                case "rect":
                                        l = 1 / Math.SQRT2 * i,
                                    t.beginPath(),
                                    t.fillRect(n - l, o - l, 2 * l, 2 * l),
                                    t.strokeRect(n - l, o - l, 2 * l, 2 * l);
                                    break;
                                case "rectRounded":
                                        var c = i / Math.SQRT2,
                                        u = n - c,
                                        h = o - c,
                                        c = Math.SQRT2 * i;d.helpers.drawRoundedRectangle(t, u, h, c, c, i / 2),
                                    t.fill();
                                    break;
                                case "rectRot":
                                        l = 1 / Math.SQRT2 * i,
                                ...
                                case "crossRot":
                                        t.beginPath(),
                                    r = Math.cos(Math.PI / 4) * i,
                                    a = Math.sin(Math.PI / 4) * i,
                                    t.moveTo(n - r, o - a),
                                    t.lineTo(n + r, o + a),
                                    t.moveTo(n - r, o + a),
                                    t.lineTo(n + r, o - a),
        ...
        23: [function(t, e, i) {
            ...
            e.exports = function(a) {
                var l = a.helpers,
                    r = a.plugins,
                    c = a.platform;
                a.types = {}, a.instances = {}, a.controllers = {}, a.Controller = function(t, e, i) {
                    var n = this;
                    (s = (r = (r = e) || {}).data = r.data || {}).datasets = s.datasets || [], s.labels = s.labels || [], r.options = l.configMerge(a.defaults.global, a.defaults[r.type], r.options || {}), e = r;
                    var o = c.acquireContext(t, e),
                        s = o && o.canvas,
                        r = s && s.height,
                        t = s && s.width;
                    return i.ctx = o, i.canvas = s, i.config = e, i.width = t, i.height = r, i.aspectRatio = r ? t / r : null, n.id = l.uid(), n.chart = i, n.config = e, n.options = e.options, n._bufferedRender = !1, a.instances[n.id] = n, Object.defineProperty(n, "data", {
                        get: function() {
                            return n.config.data
                        }
                    }), o && s ? (n.initialize(), n.update()) : console.error("Failed to create chart: can't acquire context from the given item"), n
                }, l.extend(a.Controller.prototype, {
                    initialize: function() {
                        var t = this;
                        return r.notify(t, "beforeInit"), l.retinaScale(t.chart), t.bindEvents(), t.options.responsive && t.resize(!0), t.ensureScalesHaveIDs(), t.buildScales(), t.initToolTip(), r.notify(t, "afterInit"), t
                    },
                    clear: function() {
                        return l.clear(this.chart), this
                    },
                    stop: function() {
                    ...
                    resize: function(t) {
                        var e = this,
                            ...
                            n = e.options,
                            o = i.canvas,
                            s = n.maintainAspectRatio && i.aspectRatio || null,
                            n = Math.floor(l.getMaximumWidth(o)),
                            s = Math.floor(s ? n / s : l.getMaximumHeight(o));
                        i.width === n && i.height === s || (o.width = i.width = n, o.height = i.height = s, o.style.width = n + "px", o.style.height = s + "px", l.retinaScale(i), t) || (s = {
                            width: n,
                            height: s
                        }, r.notify(e, "resize", [s]), e.options.onResize && e.options.onResize(e, s), e.stop(), e.update(e.options.responsiveAnimationDuration))
                    },
                    ensureScalesHaveIDs: function() {
                        var t = this.options,
                            e = t.scales || {},
                            t = t.scale;
                        l.each(e.xAxes, function(t, e) {
                            t.id = t.id || "x-axis-" + e
                        }), l.each(e.yAxes, function(t, e) {
                            t.id = t.id || "y-axis-" + e
                        }), t && (t.id = t.id || "scale")
                    },
                    buildScales: function() {
                        ...
                        t.scales && (e = e.concat((t.scales.xAxes || []).map(function(t) {
                            ...
                            var e = t.options,
                                i = l.getValueOrDefault(e.type, t.dtype),
                                i = a.scaleService.getScaleConstructor(i);
                            i && (e = new i({
                                id: e.id,
                                options: e,
                                ctx: n.chart.ctx,
                                chart: n
                            }), o[e.id] = e, t.isDefault && (n.scale = e))
                    ...
                    buildOrUpdateControllers: function() {
                        var n = this,
                            o = [],
                            s = [];
                        if (l.each(n.data.datasets, function(t, e) {
                                var i = n.getDatasetMeta(e);
                                i.type || (i.type = t.type || n.config.type), o.push(i.type), i.controller ? i.controller.updateIndex(e) : (i.controller = new a.controllers[i.type](n, e), s.push(i.controller))
                            }, n), 1 < o.length)
                    ...
                    resetElements: function() {
                        var i = this;
                        l.each(i.data.datasets, function(t, e) {
                    ...
                    update: function(t, e) {
                        var i, n, o = this;
                        (n = (i = o).options).scale ? i.scale.options = n.scale : n.scales && n.scales.xAxes.concat(n.scales.yAxes).forEach(function(t) {
                            i.scales[t.id].options = t
                        }), i.tooltip._options = n.tooltips, !1 !== r.notify(o, "beforeUpdate") && (o.tooltip._data = o.data, n = o.buildOrUpdateControllers(), l.each(o.data.datasets, function(t, e) {
                            o.getDatasetMeta(e).controller.buildOrUpdateElements()
                        }, o), o.updateLayout(), l.each(n, function(t) {
                            t.reset()
                        }), o.updateDatasets(), r.notify(o, "afterUpdate"), o._bufferedRender ? o._bufferedRequest = {
                            lazy: e,
                            duration: t
                        } : o.render(t, e))
                    },
                    updateLayout: function() {
                        !1 !== r.notify(this, "beforeLayout") && (a.layoutService.update(this, this.chart.width, this.chart.height), r.notify(this, "afterScaleUpdate"), r.notify(this, "afterLayout"))
                    },
                    updateDatasets: function() {
                        if (!1 !== r.notify(this, "beforeDatasetsUpdate")) {
                    ...
                    render: function(t, e) {
                        ...
                        if (!1 !== r.notify(i, "beforeRender")) {
                            ...
                            return o && (void 0 !== t && 0 !== t || void 0 === t && 0 !== o.duration) ? ((n = new a.Animation).numSteps = (t || o.duration) / 16.66, n.easing = o.easing, n.render = function(t, e) {
                                var i = l.easingEffects[e.easing],
                                    n = e.currentStep / e.numSteps,
                                    i = i(n);
                                t.draw(i, n, e.currentStep)
                            }, n.onAnimationProgress = o.onProgress, n.onAnimationComplete = s, a.animationService.addAnimation(i, n, t, e)) : (i.draw(), s()), i
                        }
                    },
                    draw: function(t) {
                        var e = this;
                        e.clear(), null != t || (t = 1), !1 !== r.notify(e, "beforeDraw", [t]) && (l.each(e.boxes, function(t) {
                            t.draw(e.chartArea)
                        }, e), e.scale && e.scale.draw(), e.drawDatasets(t), e.tooltip.transition(t).draw(), r.notify(e, "afterDraw", [t]))
                    },
                    drawDatasets: function(i) {
                        var n = this;
                        !1 !== r.notify(n, "beforeDatasetsDraw", [i]) && (l.each(n.data.datasets, function(t, e) {
                            n.isDatasetVisible(e) && n.getDatasetMeta(e).controller.draw(i)
                        }, n, !0), r.notify(n, "afterDatasetsDraw", [i]))
                    },
                    getElementAtEvent: function(t) {
                        return a.Interaction.modes.single(this, t)
                    },
                    getElementsAtEvent: function(t) {
                        return a.Interaction.modes.label(this, t, {
                            intersect: !0
                        })
                    },
                    getElementsAtXAxis: function(t) {
                        return a.Interaction.modes["x-axis"](this, t, {
                            intersect: !0
                        })
                    },
                    getElementsAtEventForMode: function(t, e, i) {
                        e = a.Interaction.modes[e];
                        return "function" == typeof e ? e(this, t, i) : []
                    },
                    getDatasetAtEvent: function(t) {
                        return a.Interaction.modes.dataset(this, t, {
                            intersect: !0
                        })
                    },
                    ...
                    destroy: function() {
                        ...
                        o && (n.unbindEvents(), l.clear(n.chart), c.releaseContext(n.chart.ctx), n.chart.canvas = null, n.chart.ctx = null), r.notify(n, "destroy"), delete a.instances[n.id]
                    },
                    ...
                    bindEvents: function() {
                        ...
                        l.each(e.options.events, function(t) {
                            c.addEventListener(e, t, n), i[t] = n
                        }), e.options.responsive && (n = function() {
                            e.resize()
                        }, c.addEventListener(e, "resize", n), i.resize = n)
                    },
                    unbindEvents: function() {
                        var i = this,
                            t = i._listeners;
                        t && (delete i._listeners, l.each(t, function(t, e) {
                            c.removeEventListener(i, e, t)
                        }))
                    },
                    updateHoverStyle: function(t, e, i) {
                        for (var n, o = i ? "setHoverStyle" : "removeHoverStyle", s = 0, r = t.length; s < r; ++s)(n = t[s]) && this.getDatasetMeta(n._datasetIndex).controller[o](n)
                    },
                    eventHandler: function(t) {
                        ...
                        if (!1 !== r.notify(e, "beforeEvent", [t])) {
                            ...
                            return t ? e.render(t.duration, t.lazy) : n && !e.animating && (e.stop(), e.render(e.options.hover.animationDuration, !0)), e._bufferedRender = !1, e._bufferedRequest = null, e
                        }
                    },
                    handleEvent: function(t) {
                        var e, i = this,
                            n = i.options || {},
                            o = n.hover;
                        return i.lastActive = i.lastActive || [], "mouseout" === t.type ? i.active = [] : i.active = i.getElementsAtEventForMode(t, o.mode, o), o.onHover && o.onHover.call(i, t.native, i.active), "mouseup" !== t.type && "click" !== t.type || n.onClick && n.onClick.call(i, t.native, i.active), i.lastActive.length && i.updateHoverStyle(i.lastActive, o.mode, !1), i.active.length && o.mode && i.updateHoverStyle(i.active, o.mode, !0), e = !l.arrayEquals(i.active, i.lastActive), i.lastActive = i.active, e
                    }
                })
            }
        }, {}],
        24: [function(t, e, i) {
            ...
            e.exports = function(t) {
                function n(e, t) {
                    var i = e._chartjs;
                    i && (-1 !== (t = (i = i.listeners).indexOf(t)) && i.splice(t, 1), 0 < i.length || (s.forEach(function(t) {
                        delete e[t]
                    }), delete e._chartjs))
                }
                var r = t.helpers,
                    s = ["push", "pop", "shift", "splice", "unshift"];
                t.DatasetController = function(t, e) {
                    ...
                    buildOrUpdateElements: function() {
                        var o, t = this,
                            e = t.getDataset(),
                            i = e.data || (e.data = []);
                        t._data !== i && (t._data && n(t._data, t), e = t, (o = i)._chartjs ? o._chartjs.listeners.push(e) : (Object.defineProperty(o, "_chartjs", {
                            configurable: !0,
                            enumerable: !1,
                            value: {
                                listeners: [e]
                    ...
                    removeHoverStyle: function(t, e) {
                        var i = this.chart.data.datasets[t._datasetIndex],
                            n = t._index,
                            o = t.custom || {},
                            s = r.getValueAtIndexOrDefault,
                            t = t._model;
                        t.backgroundColor = o.backgroundColor || s(i.backgroundColor, n, e.backgroundColor), t.borderColor = o.borderColor || s(i.borderColor, n, e.borderColor), t.borderWidth = o.borderWidth || s(i.borderWidth, n, e.borderWidth)
                    },
                    setHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex],
                            i = t._index,
                            ...
                            s = r.getHoverColor,
                            t = t._model;
                        t.backgroundColor = n.hoverBackgroundColor || o(e.hoverBackgroundColor, i, s(t.backgroundColor)), t.borderColor = n.hoverBorderColor || o(e.hoverBorderColor, i, s(t.borderColor)), t.borderWidth = n.hoverBorderWidth || o(e.hoverBorderWidth, i, t.borderWidth)
                    },
            ...
            e.exports = function(t) {
                ...
                t.elements = {}, t.Element = function(t) {
                    ...
                    transition: function(o) {
                        var s = this;
                        return s._view || (s._view = r.clone(s._model)), 1 === o ? (s._view = s._model, s._start = null) : (s._start || s.pivot(), r.each(s._model, function(e, i) {
                            if ("_" !== i[0])
                                if (s._view.hasOwnProperty(i)) {
                                    if (e !== s._view[i])
                                        if ("string" == typeof e) try {
                                            var t = r.color(s._model[i]).mix(r.color(s._start[i]), o);
                                            s._view[i] = t.rgbString()
                                        } catch (t) {
                                            s._view[i] = e
                                        } else {
                                            var n;
                                            "number" == typeof e ? (n = void 0 !== s._start[i] && !1 === isNaN(s._start[i]) ? s._start[i] : 0, s._view[i] = (s._model[i] - n) * o + n) : s._view[i] = e
                                        }
                                } else "number" != typeof e || isNaN(s._view[i]) ? s._view[i] = e : s._view[i] = e * o
                        }, s)), s
                    },
        ...
        26: [function(t, e, i) {
            ...
            e.exports = function(s) {
                ...
                function e(t, e, i) {
                    ...
                    return a || n ? Math.min(a ? l(s, t, i) : e, n ? l(r, o, i) : e) : "none"
                }
                var t, d = s.helpers = {};
                d.each = function(t, e, i, n) {
                    if (d.isArray(t))
                        if (s = t.length, n)
                            for (r = s - 1; 0 <= r; r--) e.call(i, t[r], r);
                        else
                            for (r = 0; r < s; r++) e.call(i, t[r], r);
                    else if ("object" == typeof t)
                        for (var o = Object.keys(t), s = o.length, r = 0; r < s; r++) e.call(i, t[o[r]], o[r])
                }, d.clone = function(t) {
                    var i = {};
                    return d.each(t, function(t, e) {
                        d.isArray(t) ? i[e] = t.slice(0) : i[e] = "object" == typeof t && null !== t ? d.clone(t) : t
                    }), i
                }, d.extend = function(i) {
                    ...
                    return i
                }, d.configMerge = function(t) {
                    var o = d.clone(t);
                    return d.each(Array.prototype.slice.call(arguments, 1), function(t) {
                        d.each(t, function(t, e) {
                            var i = o.hasOwnProperty(e),
                                n = i ? o[e] : {};
                            "scales" === e ? o[e] = d.scaleMerge(n, t) : "scale" === e ? o[e] = d.configMerge(n, s.scaleService.getScaleDefaults(t.type), t) : !i || "object" != typeof n || d.isArray(n) || null === n || "object" != typeof t || d.isArray(t) ? o[e] = t : o[e] = d.configMerge(n, t)
                        })
                    }), o
                }, d.scaleMerge = function(t, e) {
                    var o = d.clone(t);
                    return d.each(e, function(t, n) {
                        "xAxes" === n || "yAxes" === n ? o.hasOwnProperty(n) ? d.each(t, function(t, e) {
                            var i = d.getValueOrDefault(t.type, "xAxes" === n ? "category" : "linear"),
                                i = s.scaleService.getScaleDefaults(i);
                            e >= o[n].length || !o[n][e].type ? o[n].push(d.configMerge(i, t)) : t.type && t.type !== o[n][e].type ? o[n][e] = d.configMerge(o[n][e], i, t) : o[n][e] = d.configMerge(o[n][e], t)
                        }) : (o[n] = [], d.each(t, function(t) {
                            var e = d.getValueOrDefault(t.type, "xAxes" === n ? "category" : "linear");
                            o[n].push(d.configMerge(s.scaleService.getScaleDefaults(e), t))
                        })) : o.hasOwnProperty(n) && "object" == typeof o[n] && null !== o[n] && "object" == typeof t ? o[n] = d.configMerge(o[n], t) : o[n] = t
                    }), o
                }, d.getValueAtIndexOrDefault = function(t, e, i) {
                    return null == t ? i : d.isArray(t) ? e < t.length ? t[e] : i : t
                }, d.getValueOrDefault = function(t, e) {
                    return void 0 === t ? e : t
                    ...
                    if (d.isArray(t) && Array.prototype.filter) return t.filter(e);
                    var i = [];
                    return d.each(t, function(t) {
                        e(t) && i.push(t)
                    }), i
                }, d.findIndex = Array.prototype.findIndex ? function(t, e, i) {
                    ...
                    return -1
                }, d.findNextWhere = function(t, e, i) {
                    null != i || (i = -1);
                    for (var n = i + 1; n < t.length; n++) {
                        var o = t[n];
                        if (e(o)) return o
                    }
                }, d.findPreviousWhere = function(t, e, i) {
                    null != i || (i = t.length);
                    for (var n = i - 1; 0 <= n; n--) {
                        var o = t[n];
                        if (e(o)) return o
                    }
                }, d.inherits = function(t) {
                    function e() {
                        this.constructor = n
                    }
                    var i = this,
                ...
                }, d.noop = function() {}, d.uid = (t = 0, function() {
                    return t++
                }), d.isNumber = function(t) {
                    return !isNaN(parseFloat(t)) && isFinite(t)
                }, d.almostEquals = function(t, e, i) {
                    return Math.abs(t - e) < i
                }, d.almostWhole = function(t, e) {
                    var i = Math.round(t);
                    return i - e < t && t < i + e
                }, d.max = function(t) {
                ...
                }, d.sign = Math.sign ? function(t) {
                    return Math.sign(t)
                } : function(t) {
                    return 0 === (t = +t) || isNaN(t) ? t : 0 < t ? 1 : -1
                }, d.log10 = Math.log10 ? function(t) {
                    return Math.log10(t)
                } : function(t) {
                    return Math.log(t) / Math.LN10
                }, d.toRadians = function(t) {
                    return t * (Math.PI / 180)
                }, d.toDegrees = function(t) {
                    return t * (180 / Math.PI)
                }, d.getAngleFromPoint = function(t, e) {
                    var i = e.x - t.x,
                        e = e.y - t.y,
                        t = Math.sqrt(i * i + e * e),
                        i = Math.atan2(e, i);
                ...
                }, d.distanceBetweenPoints = function(t, e) {
                    return Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2))
                }, d.aliasPixel = function(t) {
                    return t % 2 == 0 ? 0 : .5
                }, d.splineCurve = function(t, e, i, n) {
                    var o = t.skip ? e : t,
                        s = e,
                        r = i.skip ? e : i,
                        t = Math.sqrt(Math.pow(s.x - o.x, 2) + Math.pow(s.y - o.y, 2)),
                        e = Math.sqrt(Math.pow(r.x - s.x, 2) + Math.pow(r.y - s.y, 2)),
                        i = t / (t + e),
                        e = e / (t + e),
                        i = n * (i = isNaN(i) ? 0 : i),
                        e = n * (e = isNaN(e) ? 0 : e);
                ...
                }, d.EPSILON = Number.EPSILON || 1e-14, d.splineCurveMonotone = function(t) {
                    for (var e, i, n, o, s, r, a, l, c = (t || []).map(function(t) {
                            return {
                                model: t._model,
                                deltaK: 0,
                                mK: 0
                            }
                        }), u = c.length, h = 0; h < u; ++h)(o = c[h]).model.skip || (i = 0 < h ? c[h - 1] : null, (n = h < u - 1 ? c[h + 1] : null) && !n.model.skip && (e = n.model.x - o.model.x, o.deltaK = 0 != e ? (n.model.y - o.model.y) / e : 0), !i || i.model.skip ? o.mK = o.deltaK : !n || n.model.skip ? o.mK = i.deltaK : this.sign(i.deltaK) !== this.sign(o.deltaK) ? o.mK = 0 : o.mK = (i.deltaK + o.deltaK) / 2);
                    for (h = 0; h < u - 1; ++h) o = c[h], n = c[h + 1], o.model.skip || n.model.skip || (d.almostEquals(o.deltaK, 0, this.EPSILON) ? o.mK = n.mK = 0 : (s = o.mK / o.deltaK, r = n.mK / o.deltaK, (a = Math.pow(s, 2) + Math.pow(r, 2)) <= 9 || (a = 3 / Math.sqrt(a), o.mK = s * a * o.deltaK, n.mK = r * a * o.deltaK)));
                    for (h = 0; h < u; ++h)(o = c[h]).model.skip || (i = 0 < h ? c[h - 1] : null, n = h < u - 1 ? c[h + 1] : null, i && !i.model.skip && (l = (o.model.x - i.model.x) / 3, o.model.controlPointPreviousX = o.model.x - l, o.model.controlPointPreviousY = o.model.y - l * o.mK), n && !n.model.skip && (l = (n.model.x - o.model.x) / 3, o.model.controlPointNextX = o.model.x + l, o.model.controlPointNextY = o.model.y + l * o.mK))
                }, d.nextItem = function(t, e, i) {
                    return i ? e >= t.length - 1 ? t[0] : t[e + 1] : e >= t.length - 1 ? t[t.length - 1] : t[e + 1]
                }, d.previousItem = function(t, e, i) {
                    return i ? e <= 0 ? t[t.length - 1] : t[e - 1] : e <= 0 ? t[0] : t[e - 1]
                }, d.niceNum = function(t, e) {
                    var i = Math.floor(d.log10(t)),
                        t = t / Math.pow(10, i);
                    return (e ? t < 1.5 ? 1 : t < 3 ? 2 : t < 7 ? 5 : 10 : t <= 1 ? 1 : t <= 2 ? 2 : t <= 5 ? 5 : 10) * Math.pow(10, i)
                };
                var i = d.easingEffects = {
                    linear: function(t) {
                        return t
                    },
                ...
                d.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
                    return window.setTimeout(t, 1e3 / 60)
                }, d.getRelativePosition = function(t, e) {
                    var i = t.originalEvent || t,
                        n = t.currentTarget || t.srcElement,
                        o = n.getBoundingClientRect(),
                        s = i.touches,
                        r = s && 0 < s.length ? (l = s[0].clientX, s[0].clientY) : (l = i.clientX, i.clientY),
                        a = parseFloat(d.getStyle(n, "padding-left")),
                        t = parseFloat(d.getStyle(n, "padding-top")),
                        s = parseFloat(d.getStyle(n, "padding-right")),
                        i = parseFloat(d.getStyle(n, "padding-bottom")),
                        s = o.right - o.left - a - s,
                        i = o.bottom - o.top - t - i,
                        l = Math.round((l - o.left - a) / s * n.width / e.currentDevicePixelRatio);
                    return {
                        x: l,
                        y: r = Math.round((r - o.top - t) / i * n.height / e.currentDevicePixelRatio)
                    }
                }, d.addEvent = function(t, e, i) {
                    t.addEventListener ? t.addEventListener(e, i) : t.attachEvent ? t.attachEvent("on" + e, i) : t["on" + e] = i
                }, d.removeEvent = function(t, e, i) {
                    t.removeEventListener ? t.removeEventListener(e, i, !1) : t.detachEvent ? t.detachEvent("on" + e, i) : t["on" + e] = d.noop
                }, d.getConstraintWidth = function(t) {
                    return e(t, "max-width", "clientWidth")
                }, d.getConstraintHeight = function(t) {
                    return e(t, "max-height", "clientHeight")
                }, d.getMaximumWidth = function(t) {
                    var e = t.parentNode,
                        i = parseInt(d.getStyle(e, "padding-left"), 10),
                        n = parseInt(d.getStyle(e, "padding-right"), 10),
                        n = e.clientWidth - i - n,
                        t = d.getConstraintWidth(t);
                    return isNaN(t) ? n : Math.min(n, t)
                }, d.getMaximumHeight = function(t) {
                    var e = t.parentNode,
                        i = parseInt(d.getStyle(e, "padding-top"), 10),
                        n = parseInt(d.getStyle(e, "padding-bottom"), 10),
                        n = e.clientHeight - i - n,
                        t = d.getConstraintHeight(t);
                    return isNaN(t) ? n : Math.min(n, t)
                }, d.getStyle = function(t, e) {
                    return t.currentStyle ? t.currentStyle[e] : document.defaultView.getComputedStyle(t, null).getPropertyValue(e)
                }, d.retinaScale = function(t) {
                ...
                }, d.fontString = function(t, e, i) {
                    return e + " " + t + "px " + i
                }, d.longestText = function(e, t, i, n) {
                    var o = (n = n || {}).data = n.data || {},
                        s = n.garbageCollect = n.garbageCollect || [];
                    n.font !== t && (o = n.data = {}, s = n.garbageCollect = [], n.font = t), e.font = t;
                    var r = 0;
                    d.each(i, function(t) {
                        null != t && !0 !== d.isArray(t) ? r = d.measureText(e, o, s, r, t) : d.isArray(t) && d.each(t, function(t) {
                            null == t || d.isArray(t) || (r = d.measureText(e, o, s, r, t))
                        })
                    });
                    var a = s.length / 2;
                    if (a > i.length) {
                    ...
                    return r
                }, d.measureText = function(t, e, i, n, o) {
                    var s = e[o];
                    return s || (s = e[o] = t.measureText(o).width, i.push(o)), n < s && (n = s), n
                }, d.numberOfLabelLines = function(t) {
                    var e = 1;
                    return d.each(t, function(t) {
                        d.isArray(t) && t.length > e && (e = t.length)
                    }), e
                }, d.drawRoundedRectangle = function(t, e, i, n, o, s) {
                    ...
                    return n ? n(t instanceof CanvasGradient ? s.defaults.global.defaultColor : t) : (console.error("Color.js not found!"), t)
                }, d.isArray = Array.isArray ? function(t) {
                    return Array.isArray(t)
                } : function(t) {
                    return "[object Array]" === Object.prototype.toString.call(t)
                }, d.arrayEquals = function(t, e) {
                    var i, n, o, s;
                    if (!t || !e || t.length !== e.length) return !1;
                    for (i = 0, n = t.length; i < n; ++i)
                        if (o = t[i], s = e[i], o instanceof Array && s instanceof Array) {
                            if (!d.arrayEquals(o, s)) return !1
                        } else if (o !== s) return !1;
                    return !0
                }, d.callCallback = function(t, e, i) {
                    t && "function" == typeof t.call && t.apply(i, e)
                }, d.getHoverColor = function(t) {
                    return t instanceof CanvasPattern ? t : d.color(t).saturate(.5).darken(.1).rgbString()
                }
            }
        }, {
            3: 3
        ...
        27: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                function a(t, e) {
                    for (var i, n, o, s = 0, r = t.data.datasets.length; s < r; ++s)
                        if (t.isDatasetVisible(s))
                            for (n = 0, o = (i = t.getDatasetMeta(s)).data.length; n < o; ++n) {
                                var a = i.data[n];
                                a._view.skip || e(a)
                            }
                }
                ...
                function l(t, i, n, o) {
                    var s = Number.POSITIVE_INFINITY,
                        r = [];
                    return o = o || c.distanceBetweenPoints, a(t, function(t) {
                        var e;
                        n && !t.inRange(i.x, i.y) || (e = t.getCenterPoint(), (e = o(i, e)) < s ? (r = [t], s = e) : e === s && r.push(t))
                    }), r
                }

                function i(i, t, e) {
                    var t = r(t, i.chart),
                        n = e.intersect ? s(i, t) : l(i, t, !1, function(t, e) {
                            return Math.abs(t.x - e.x)
                        }),
                        o = [];
                    return n.length ? (i.data.datasets.forEach(function(t, e) {
                        !i.isDatasetVisible(e) || (e = i.getDatasetMeta(e).data[n[0]._index]) && !e._view.skip && o.push(e)
                    }), o) : []
                }
                var c = t.helpers;
                t.Interaction = {
                    modes: {
                        ...
                        dataset: function(t, e, i) {
                            e = r(e, t.chart), e = i.intersect ? s(t, e) : l(t, e, !1);
                            return 0 < e.length && (e = t.getDatasetMeta(e[0]._datasetIndex).data), e
                        },
                        "x-axis": function(t, e) {
                            return i(t, e, !0)
                        },
                        point: function(t, e) {
                            return s(t, r(e, t.chart))
                        },
                        nearest: function(t, e, i) {
                            i = l(t, r(e, t.chart), i.intersect);
                            return 1 < i.length && i.sort(function(t, e) {
            ...
            e.exports = function(t) {
                ...
                t.layoutService = {
                    ...
                    update: function(e, i, t) {
                        function n(e) {
                            var t, i = $.findNextWhere(x, function(t) {
                                return t.box === e
                            });
                            i && (e.isHorizontal() ? (t = {
                                left: Math.max(S, w),
                                ...
                                top: 0,
                                bottom: 0
                            }, e.update(e.options.fullWidth ? f : v, p / 2, t)) : e.update(i.minSize.width, b))
                        }

                        function o(t) {
                            t.isHorizontal() ? (t.left = t.options.fullWidth ? s : S, t.right = t.options.fullWidth ? i - r : S + v, t.top = O, t.bottom = O + t.height, O = t.bottom) : (t.left = E, t.right = E + t.width, t.top = M, t.bottom = M + b, E = t.right)
                        }
                        var s, r, a, l, c, u, h, d, f, p, g, m, y, v, b, x, w, _, k, C, S, T, M, I, A, P, z, D, E, O;
                        e && (A = (d = e.options.layout) ? d.padding : null, P = a = r = s = 0, P = isNaN(A) ? (s = A.left || 0, r = A.right || 0, a = A.top || 0, A.bottom || 0) : a = r = s = A, l = $.where(e.boxes, function(t) {
                            return "left" === t.options.position
                        }), c = $.where(e.boxes, function(t) {
                            return "right" === t.options.position
                        }), u = $.where(e.boxes, function(t) {
                            return "top" === t.options.position
                        }), h = $.where(e.boxes, function(t) {
                            return "bottom" === t.options.position
                        }), d = $.where(e.boxes, function(t) {
                            return "chartArea" === t.options.position
                        }), u.sort(function(t, e) {
                            return (e.options.fullWidth ? 1 : 0) - (t.options.fullWidth ? 1 : 0)
                        }), h.sort(function(t, e) {
                            return (t.options.fullWidth ? 1 : 0) - (e.options.fullWidth ? 1 : 0)
                        }), g = (p = t - a - P) / 2, m = (i - (f = i - s - r) / 2) / (l.length + c.length), y = (t - g) / (u.length + h.length), v = f, b = p, x = [], $.each(l.concat(c, u, h), function(t) {
                            var e, i = t.isHorizontal();
                            i ? (e = t.update(t.options.fullWidth ? f : v, y), b -= e.height) : (e = t.update(m, g), v -= e.width), x.push({
                                horizontal: i,
                                minSize: e,
                                box: t
                            })
                        }), C = k = _ = w = 0, $.each(u.concat(h), function(t) {
                            t.getPadding && (t = t.getPadding(), w = Math.max(w, t.left), _ = Math.max(_, t.right))
                        }), $.each(l.concat(c), function(t) {
                            t.getPadding && (t = t.getPadding(), k = Math.max(k, t.top), C = Math.max(C, t.bottom))
                        }), S = s, T = r, M = a, I = P, $.each(l.concat(c), n), $.each(l, function(t) {
                            S += t.width
                        }), $.each(c, function(t) {
                            T += t.width
                        }), $.each(u.concat(h), n), $.each(u, function(t) {
                            M += t.height
                        }), $.each(h, function(t) {
                            I += t.height
                        }), $.each(l.concat(c), function(e) {
                            var t = $.findNextWhere(x, function(t) {
                                    return t.box === e
                                }),
                                i = {
                                    left: 0,
                        ...
                        }), S = s, T = r, M = a, I = P, $.each(l, function(t) {
                            S += t.width
                        }), $.each(c, function(t) {
                            T += t.width
                        }), $.each(u, function(t) {
                            ...
                            I += t.height
                        }), A = Math.max(w - S, 0), S += A, T += Math.max(_ - T, 0), P = Math.max(k - M, 0), M += P, I += Math.max(C - I, 0), z = t - M - I, (D = i - S - T) === v && z === b || ($.each(l, function(t) {
                            t.height = z
                        }), $.each(c, function(t) {
                            t.height = z
                        }), $.each(u, function(t) {
                            t.options.fullWidth || (t.width = D)
                        }), $.each(h, function(t) {
                            t.options.fullWidth || (t.width = D)
                        }), b = z, v = D), E = s + A, O = a + P, $.each(l.concat(u), o), E += v, O += b, $.each(c, o), $.each(h, o), e.chartArea = {
                            left: S,
                            top: M,
                            right: S + v,
                            bottom: M + b
                        }, $.each(d, function(t) {
                            t.left = e.chartArea.left, t.top = e.chartArea.top, t.right = e.chartArea.right, t.bottom = e.chartArea.bottom, t.update(v, b)
                        }))
                    }
                }
            }
        ...
        30: [function(t, e, i) {
            ...
            e.exports = function(I) {
                ...
                function i(t, e) {
                    ...
                    t.legend = e, I.layoutService.addBox(t, e)
                }
                var P = I.helpers,
                    t = P.noop;
                I.defaults.global.legend = {
                    display: !0,
                    position: "top",
                    fullWidth: !0,
                    reverse: !1,
                    ...
                    fit: function() {
                        var i, n, o, s, r, a, l, c = this,
                            ...
                            h = c.ctx,
                            d = I.defaults.global,
                            f = P.getValueOrDefault,
                            p = f(u.fontSize, d.defaultFontSize),
                            t = f(u.fontStyle, d.defaultFontStyle),
                            d = f(u.fontFamily, d.defaultFontFamily),
                            t = P.fontString(p, t, d),
                            g = c.legendHitBoxes = [],
                            m = c.minSize,
                            d = c.isHorizontal();
                        d ? (m.width = c.maxWidth, m.height = e ? 10 : 0) : (m.width = e ? 10 : 0, m.height = c.maxHeight), e && (h.font = t, d ? (i = c.lineWidths = [0], n = c.legendItems.length ? p + u.padding : 0, h.textAlign = "left", h.textBaseline = "top", P.each(c.legendItems, function(t, e) {
                            t = A(u, p) + p / 2 + h.measureText(t.text).width;
                            i[i.length - 1] + t + u.padding >= c.width && (n += p + u.padding, i[i.length] = c.left), g[e] = {
                                left: 0,
                                top: 0,
                                width: t,
                                height: p
                            }, i[i.length - 1] += t + u.padding
                        }), m.height += n) : (d = u.padding, o = c.columnWidths = [], s = u.padding, a = r = 0, l = p + d, P.each(c.legendItems, function(t, e) {
                            t = A(u, p) + p / 2 + h.measureText(t.text).width;
                            a + l > m.height && (s += r + u.padding, o.push(r), a = r = 0), r = Math.max(r, t), a += l, g[e] = {
                                left: 0,
                                top: 0,
                                width: t,
                                height: p
                            }
                        }), s += r, o.push(r), m.width += s)), c.width = m.width, c.height = m.height
                    },
                    afterFit: t,
                    ...
                    draw: function() {
                        var f, p, t, g, e, i, m, y, v, b, x, w = this,
                            _ = w.options,
                            k = _.labels,
                            C = I.defaults.global,
                            S = C.elements.line,
                            T = w.width,
                            M = w.lineWidths;
                        _.display && (f = w.ctx, t = (p = P.getValueOrDefault)(k.fontColor, C.defaultFontColor), g = p(k.fontSize, C.defaultFontSize), e = p(k.fontStyle, C.defaultFontStyle), i = p(k.fontFamily, C.defaultFontFamily), i = P.fontString(g, e, i), f.textAlign = "left", f.textBaseline = "top", f.lineWidth = .5, f.strokeStyle = t, f.fillStyle = t, f.font = i, m = A(k, g), y = w.legendHitBoxes, v = w.isHorizontal(), b = v ? {
                            x: w.left + (T - M[0]) / 2,
                            y: w.top + k.padding,
                            line: 0
                        } : {
                    ...
                    handleEvent: function(t) {
                        ...
                        if (s >= e.left && s <= e.right && r >= e.top && r <= e.bottom)
                            for (var a = e.legendHitBoxes, l = 0; l < a.length; ++l) {
                                var c = a[l];
                                if (s >= c.left && s <= c.left + c.width && r >= c.top && r <= c.top + c.height) {
                                    if ("click" === n) {
                    ...
                    beforeUpdate: function(t) {
                        var e = t.options.legend;
                        e ? (e = P.configMerge(I.defaults.global.legend, e), t.legend ? t.legend.options = e : i(t, e)) : (I.layoutService.removeBox(t, t.legend), delete t.legend)
                    },
        ...
        31: [function(t, e, i) {
            ...
            e.exports = function(i) {
                var a = i.helpers;
                i.defaults.global.plugins = {}, i.plugins = {
                    _plugins: [],
                    _cacheId: 0,
                    register: function(t) {
                        var e = this._plugins;
                    ...
                    notify: function(t, e, i) {
                        for (var n, o, s, r, a = this.descriptors(t), l = a.length, c = 0; c < l; ++c)
                            if ("function" == typeof(r = (o = (n = a[c]).plugin)[e]) && ((s = [t].concat(i || [])).push(n.options), !1 === r.apply(o, s))) return !1;
                        return !0
                    },
                    descriptors: function(t) {
                        ...
                        var n = [],
                            o = [],
                            t = t && t.config || {},
                            s = i.defaults.global.plugins,
                            r = t.options && t.options.plugins || {};
                        return this._plugins.concat(t.plugins || []).forEach(function(t) {
                            var e, i; - 1 === n.indexOf(t) && (e = t.id, !1 !== (i = r[e]) && (!0 === i && (i = a.clone(s[e])), n.push(t), o.push({
                                plugin: t,
                                options: i || {}
                            })))
                        }), e.descriptors = o, e.id = this._cacheId, o
                    }
                }, i.pluginService = i.plugins, i.PluginBase = a.inherits({})
            }
        }, {}],
        32: [function(t, e, i) {
            "use strict";
            e.exports = function(d) {
                function h(t, e, i) {
                    return $.isArray(e) ? $.longestText(t, i, e) : t.measureText(e).width
                }
                ...
                function f(t) {
                    var e = $.getValueOrDefault,
                        ...
                        i = e(t.fontFamily, i.defaultFontFamily);
                    return {
                        size: n,
                        style: o,
                        family: i,
                        font: $.fontString(n, o, i)
                    }
                }
                var $ = d.helpers;
                d.defaults.scale = {
                    ...
                    ticks: {
                        ...
                        autoSkipPadding: 0,
                        labelOffset: 0,
                        callback: d.Ticks.formatters.values
                    }
                }, d.Scale = d.Element.extend({
                    getPadding: function() {
                        return {
                    ...
                    calculateTickRotation: function() {
                        ...
                        if (t.options.display && t.isHorizontal())
                            for (var s = $.longestText(e, n.font, t.ticks, t.longestTextCache), r = s, a = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; a < r && o < i.maxRotation;) {
                                var l = $.toRadians(o),
                                    c = Math.cos(l);
                    ...
                    getPixelForTick: function(t, e) {
                        ...
                        o = i.height - (i.paddingTop + i.paddingBottom);
                    ...
                    draw: function(v) {
                        ...
                        if (x.display) {
                            var w, t, o = b.ctx,
                                ...
                                n = _.autoSkip,
                                S = b.isHorizontal();
                            _.maxTicksLimit && (t = _.maxTicksLimit);
                            var s = $.getValueOrDefault(_.fontColor, e.defaultFontColor),
                                r = f(_),
                                T = k.drawTicks ? k.tickMarkLength : 0,
                                M = $.getValueOrDefault(k.borderDash, e.borderDash),
                                I = $.getValueOrDefault(k.borderDashOffset, e.borderDashOffset),
                                a = $.getValueOrDefault(i.fontColor, e.defaultFontColor),
                                l = f(i),
                                A = $.toRadians(b.labelRotation),
                                e = Math.cos(A),
                                e = b.longestLabelWidth * e;
                            o.fillStyle = s;
                            var P = [];
                            if (S) {
                                if (w = !1, C && (e /= 2), (e + _.autoSkipPadding) * b.ticks.length > b.width - (b.paddingLeft + b.paddingRight) && (w = 1 + Math.floor((e + _.autoSkipPadding) * b.ticks.length / (b.width - (b.paddingLeft + b.paddingRight)))), t && b.ticks.length > t)
                                    for (; !w || b.ticks.length / (w || 1) > t;) w = w || 1, w += 1;
                                n || (w = !1)
                            }
                            var c, u, h, z = "right" === x.position ? b.left : b.right - T,
                                D = "right" === x.position ? b.left + T : b.right,
                                E = "bottom" === x.position ? b.top : b.bottom - T,
                                O = "bottom" === x.position ? b.top + T : b.bottom;
                            $.each(b.ticks, function(t, e) {
                                var i, n, o, s, r, a, l, c, u, h, d, f, p, g, m, y;
                                null != t && (m = b.ticks.length === e + 1, (1 < w && 0 < e % w || e % w == 0 && e + w >= b.ticks.length) && !m || null == t || (n = e === (void 0 !== b.zeroLineIndex ? b.zeroLineIndex : 0) ? (i = k.zeroLineWidth, k.zeroLineColor) : (i = $.getValueAtIndexOrDefault(k.lineWidth, e), $.getValueAtIndexOrDefault(k.color, e)), c = l = "middle", S ? (a = "bottom" === x.position ? (c = C ? "middle" : "top", l = C ? "right" : "center", b.top + T) : (c = C ? "middle" : "bottom", l = C ? "left" : "center", b.bottom - T), y = b.getPixelForTick(e) + $.aliasPixel(i), u = b.getPixelForTick(e, k.offsetGridLines) + _.labelOffset, h = o = s = r = y, d = E, f = O, p = v.top, g = v.bottom) : (m = "left" === x.position, y = _.padding, y = _.mirror ? (l = m ? "left" : "right", y) : (l = m ? "right" : "left", T + y), u = m ? b.right - y : b.left + y, y = b.getPixelForTick(e), y += $.aliasPixel(i), a = b.getPixelForTick(e, k.offsetGridLines), h = z, o = D, s = v.left, r = v.right, d = f = p = g = y), P.push({
                                    tx1: h,
                                    ty1: d,
                                    tx2: o,
                                    ty2: f,
                                ...
                                if (k.display && (o.save(), o.lineWidth = t.glWidth, o.strokeStyle = t.glColor, o.setLineDash && (o.setLineDash(t.glBorderDash), o.lineDashOffset = t.glBorderDashOffset), o.beginPath(), k.drawTicks && (o.moveTo(t.tx1, t.ty1), o.lineTo(t.tx2, t.ty2)), k.drawOnChartArea && (o.moveTo(t.x1, t.y1), o.lineTo(t.x2, t.y2)), o.stroke(), o.restore()), _.display) {
                                    o.save(), o.translate(t.labelX, t.labelY), o.rotate(t.rotation), o.font = r.font, o.textBaseline = t.textBaseline, o.textAlign = t.textAlign;
                                    var e = t.label;
                                    if ($.isArray(e))
                                        for (var i = 0, n = 0; i < e.length; ++i) o.fillText("" + e[i], 0, n), n += 1.5 * r.size;
                                    else o.fillText(e, 0, 0);
                                    o.restore()
                                }
                            }), i.display && (h = 0, S ? (c = b.left + (b.right - b.left) / 2, u = "bottom" === x.position ? b.bottom - l.size / 2 : b.top + l.size / 2) : (c = (n = "left" === x.position) ? b.left + l.size / 2 : b.right - l.size / 2, u = b.top + (b.bottom - b.top) / 2, h = n ? -.5 * Math.PI : .5 * Math.PI), o.save(), o.translate(c, u), o.rotate(h), o.textAlign = "center", o.textBaseline = "middle", o.fillStyle = a, o.font = l.font, o.fillText(i.labelString, 0, 0), o.restore()), k.drawBorder && (o.lineWidth = $.getValueAtIndexOrDefault(k.lineWidth, 0), o.strokeStyle = $.getValueAtIndexOrDefault(k.color, 0), u = b.left, h = b.right, a = b.top, l = b.bottom, i = $.aliasPixel(o.lineWidth), S ? (a = l = "top" === x.position ? b.bottom : b.top, a += i, l += i) : (u = h = "left" === x.position ? b.right : b.left, u += i, h += i), o.beginPath(), o.moveTo(u, a), o.lineTo(h, l), o.stroke())
                        }
                    }
                })
            }
            ...
            e.exports = function(t) {
                ...
                t.Ticks = {
                    generators: {
                        linear: function(t, e) {
                            var i, n, o = [];
                            n = t.stepSize && 0 < t.stepSize ? t.stepSize : (i = c.niceNum(e.max - e.min, !1), c.niceNum(i / (t.maxTicks - 1), !0));
                            var s = Math.floor(e.min / n) * n,
                                e = Math.ceil(e.max / n) * n;
                            t.min && t.max && t.stepSize && c.almostWhole((t.max - t.min) / t.stepSize, n / 1e3) && (s = t.min, e = t.max);
                            var r = (e - s) / n,
                                r = c.almostEquals(r, Math.round(r), n / 1e3) ? Math.round(r) : Math.ceil(r);
                            o.push(void 0 !== t.min ? t.min : s);
                            for (var a = 1; a < r; ++a) o.push(s + a * n);
                            return o.push(void 0 !== t.max ? t.max : e), o
                        },
                        logarithmic: function(t, e) {
                            var i, n, o = [],
                                s = c.getValueOrDefault,
                                r = s(t.min, Math.pow(10, Math.floor(c.log10(e.min)))),
                                a = Math.floor(c.log10(e.max)),
                                l = Math.ceil(e.max / Math.pow(10, a));
                            for (0 === r ? (i = Math.floor(c.log10(e.minNotZero)), n = Math.floor(e.minNotZero / Math.pow(10, i)), o.push(r), r = n * Math.pow(10, i)) : (i = Math.floor(c.log10(r)), n = Math.floor(r / Math.pow(10, i))); o.push(r), ++n, 10 === n && (n = 1, ++i), r = n * Math.pow(10, i), i < a || i === a && n < l;);
                            t = s(t.max, r);
                            return o.push(t), o
                        }
                    },
        ...
        35: [function(t, e, i) {
            ...
            e.exports = function(p) {
                function i(t, e) {
                    ...
                    t.titleBlock = e, p.layoutService.addBox(t, e)
                }
                var g = p.helpers;
                ...
                p.Title = p.Element.extend({
                    initialize: function(t) {
                        g.extend(this, t), this.legendHitBoxes = []
                    },
                    beforeUpdate: t,
                    update: function(t, e, i) {
                        var n = this;
                    ...
                    beforeFit: t,
                    fit: function() {
                        var t = g.getValueOrDefault,
                            e = this.options,
                            i = p.defaults.global,
                            n = e.display,
                            t = t(e.fontSize, i.defaultFontSize),
                            i = this.minSize;
                        this.isHorizontal() ? (i.width = this.maxWidth, i.height = n ? t + 2 * e.padding : 0) : (i.width = n ? t + 2 * e.padding : 0, i.height = this.maxHeight), this.width = i.width, this.height = i.height
                    },
                    afterFit: t,
                    isHorizontal: function() {
                    ...
                    draw: function() {
                        var t, e, i, n, o, s, r, a, l, c, u = this.ctx,
                            h = g.getValueOrDefault,
                            d = this.options,
                            f = p.defaults.global;
                        d.display && (n = h(d.fontSize, f.defaultFontSize), l = h(d.fontStyle, f.defaultFontStyle), c = h(d.fontFamily, f.defaultFontFamily), o = g.fontString(n, l, c), s = 0, r = this.top, a = this.left, l = this.bottom, c = this.right, u.fillStyle = h(d.fontColor, f.defaultFontColor), u.font = o, this.isHorizontal() ? (t = a + (c - a) / 2, e = r + (l - r) / 2, i = c - a) : (t = "left" === d.position ? a + n / 2 : c - n / 2, e = r + (l - r) / 2, i = l - r, s = Math.PI * ("left" === d.position ? -.5 : .5)), u.save(), u.translate(t, e), u.rotate(s), u.textAlign = "center", u.textBaseline = "middle", u.fillText(d.text, 0, 0, i), u.restore())
                    }
                }), p.plugins.register({
                    beforeInit: function(t) {
                    ...
                    beforeUpdate: function(t) {
                        var e = t.options.title;
                        e ? (e = g.configMerge(p.defaults.global.title, e), t.titleBlock ? t.titleBlock.options = e : i(t, e)) : (p.layoutService.removeBox(t, t.titleBlock), delete t.titleBlock)
                    }
                })
            }
        }, {}],
            ...
            e.exports = function(I) {
                ...
                function P(t, e) {
                    ...
                    var a = e.title.length,
                        ...
                        u = e.bodyFontSize,
                        t = e.footerFontSize;
                    n += a * c, n += a ? (a - 1) * e.titleSpacing : 0, n += a ? e.titleMarginBottom : 0, n += r * u, n += r ? (r - 1) * e.bodySpacing : 0, n += l ? e.footerMarginTop : 0, n += l * t, n += l ? (l - 1) * e.footerSpacing : 0;

                    function h(t) {
                        o = Math.max(o, i.measureText(t).width + d)
                    }
                    var d = 0;
                    return i.font = z.fontString(c, e._titleFontStyle, e._titleFontFamily), z.each(e.title, h), i.font = z.fontString(u, e._bodyFontStyle, e._bodyFontFamily), z.each(e.beforeBody.concat(e.afterBody), h), d = e.displayColors ? u + 2 : 0, z.each(s, function(t) {
                        z.each(t.before, h), z.each(t.lines, h), z.each(t.after, h)
                    }), d = 0, i.font = z.fontString(t, e._footerFontStyle, e._footerFontFamily), z.each(e.footer, h), {
                ...
                I.defaults.global.tooltips = {
                    ...
                    getBody: function(t, i) {
                        ...
                        return z.each(t, function(t) {
                            ...
                            r(e.before, o.beforeLabel.call(n, t, i)), r(e.lines, o.label.call(n, t, i)), r(e.after, o.afterLabel.call(n, t, i)), s.push(e)
                        }), s
                    },
                    ...
                    update: function(t) {
                        var e, i, n, o, s, r, a, l, c, u, h, d, f = this,
                            p = f._options,
                            g = f._model,
                            m = f._model = A(p),
                            y = f._active,
                        ...
                        if (y.length) {
                            m.opacity = 1;
                            for (var C = [], k = I.Tooltip.positioners[p.position](y, f._eventPosition), S = [], T = 0, M = y.length; T < M; ++T) S.push((l = y[T], d = h = u = c = void 0, c = l._xScale, u = l._yScale || l._scale, h = l._index, d = l._datasetIndex, {
                                xLabel: c ? c.getLabelForIndex(h, d) : "",
                                yLabel: u ? u.getLabelForIndex(h, d) : "",
                                index: h,
                                datasetIndex: d,
                                x: l._model.x,
                                y: l._model.y
                            }));
                            p.filter && (S = S.filter(function(t) {
                                return p.filter(t, v)
                            })), p.itemSort && (S = S.sort(function(t, e) {
                                return p.itemSort(t, e, v)
                            })), z.each(S, function(t) {
                                C.push(p.callbacks.labelColor.call(f, t, b))
                            }), m.title = f.getTitle(S, v), m.beforeBody = f.getBeforeBody(S, v), m.body = f.getBody(S, v), m.afterBody = f.getAfterBody(S, v), m.footer = f.getFooter(S, v), m.x = Math.round(k.x), m.y = Math.round(k.y), m.caretPadding = z.getValueOrDefault(k.padding, 2), m.labelColors = C, m.dataPoints = S, x = function(t, e) {
                                var i = t._model,
                                    n = t._chart,
                                    o = t._chartInstance.chartArea,
                                    s = "center",
                                    r = "center";
                                i.y < e.height ? r = "top" : i.y > n.height - e.height && (r = "bottom");
                                var a, l = (o.left + o.right) / 2,
                                    c = (o.top + o.bottom) / 2,
                                    u = "center" === r ? (a = function(t) {
                                        return t <= l
                                    }, function(t) {
                                        return l < t
                                    }) : (a = function(t) {
                                ...
                                return a(i.x) ? (s = "left", h(i.x) && (s = "center", r = o(i.y))) : u(i.x) && (s = "right", d(i.x) && (s = "center", r = o(i.y))), {
                                    xAlign: (t = t._options).xAlign || s,
                                    yAlign: t.yAlign || r
                                }
                            }(this, _ = P(this, m)), i = _, n = x, o = (e = m).x, s = e.y, r = e.caretSize, a = e.caretPadding, g = e.cornerRadius, e = n.xAlign, n = n.yAlign, r += a, a = g + a, "right" === e ? o -= i.width : "center" === e && (o -= i.width / 2), "top" === n ? s += r : s -= "bottom" === n ? i.height + r : i.height / 2, "center" === n ? "left" === e ? o += r : "right" === e && (o -= r) : "left" === e ? o -= a : "right" === e && (o += a), w = {
                                x: o,
                                y: s
                            }
                        } else m.opacity = 0;
                        return m.xAlign = x.xAlign, m.yAlign = x.yAlign, m.x = w.x, m.y = w.y, m.width = _.width, m.height = _.height, m.caretX = k.x, m.caretY = k.y, f._model = m, t && p.custom && p.custom.call(f, m), f
                    },
                    drawCaret: function(t, e, i) {
                        var n, o, s, r, a, l = this._view,
                            c = this._chart.ctx,
                            u = l.caretSize,
                            h = l.cornerRadius,
                            d = l.xAlign,
                            ...
                            t = e.width,
                            e = e.height,
                            u = "center" === f ? (s = (o = "left" === d ? (n = p) - u : (n = p + t) + u, n), r = (a = g + e / 2) - u, a + u) : (s = "left" === d ? (o = (n = p + h) + u) + u : "right" === d ? (o = (n = p + t - h) - u) - u : (n = (o = p + t / 2) - u, o + u), a = "top" === f ? (r = g) - u : (r = g + e) + u, r);
                        c.fillStyle = m(l.backgroundColor, i), c.beginPath(), c.moveTo(n, r), c.lineTo(o, a), c.lineTo(s, u), c.closePath(), c.fill()
                    },
                    drawTitle: function(t, e, i, n) {
                        var o = e.title;
                        if (o.length) {
                            i.textAlign = e._titleAlign, i.textBaseline = "top";
                            var s, r, a = e.titleFontSize,
                                l = e.titleSpacing;
                            for (i.fillStyle = m(e.titleFontColor, n), i.font = z.fontString(a, e._titleFontStyle, e._titleFontFamily), s = 0, r = o.length; s < r; ++s) i.fillText(o[s], t.x, t.y), t.y += a + l, s + 1 === o.length && (t.y += e.titleMarginBottom - l)
                        }
                    },
                    drawBody: function(i, n, o, s) {
                        var r = n.bodyFontSize,
                            e = n.bodySpacing,
                            t = n.body;
                        o.textAlign = n._bodyAlign, o.textBaseline = "top";
                        var a = m(n.bodyFontColor, s);
                        o.fillStyle = a, o.font = z.fontString(r, n._bodyFontStyle, n._bodyFontFamily);

                        function l(t) {
                            o.fillText(t, i.x + c, i.y), i.y += r + e
                        }
                        var c = 0;
                        z.each(n.beforeBody, l);
                        var u = n.displayColors,
                            c = u ? r + 2 : 0;
                        z.each(t, function(t, e) {
                            z.each(t.before, l), z.each(t.lines, function(t) {
                                u && (o.fillStyle = m(n.legendColorBackground, s), o.fillRect(i.x, i.y, r, r), o.strokeStyle = m(n.labelColors[e].borderColor, s), o.strokeRect(i.x, i.y, r, r), o.fillStyle = m(n.labelColors[e].backgroundColor, s), o.fillRect(i.x + 1, i.y + 1, r - 2, r - 2), o.fillStyle = a), l(t)
                            }), z.each(t.after, l)
                        }), c = 0, z.each(n.afterBody, l), i.y -= e
                    },
                    drawFooter: function(e, i, n, t) {
                        var o = i.footer;
                        o.length && (e.y += i.footerMarginTop, n.textAlign = i._footerAlign, n.textBaseline = "top", n.fillStyle = m(i.footerFontColor, t), n.font = z.fontString(i.footerFontSize, i._footerFontStyle, i._footerFontFamily), z.each(o, function(t) {
                            n.fillText(t, e.x, e.y), e.y += i.footerFontSize + i.footerSpacing
                        }))
                    },
                    drawBackground: function(t, e, i, n, o) {
                        i.fillStyle = m(e.backgroundColor, o), z.drawRoundedRectangle(i, t.x, t.y, n.width, n.height, e.cornerRadius), i.fill()
                    },
                    draw: function() {
                    ...
                    handleEvent: function(t) {
                        var e = this,
                            i = e._options,
                            n = !1;
                        return e._lastActive = e._lastActive || [], "mouseout" === t.type ? e._active = [] : e._active = e._chartInstance.getElementsAtEventForMode(t, i.mode, i), n = !z.arrayEquals(e._active, e._lastActive), e._lastActive = e._active, (i.enabled || i.custom) && (e._eventPosition = {
                            x: t.x,
                            y: t.y
                    ...
                    average: function(t) {
                        ...
                        for (var e = 0, i = 0, n = 0, o = 0, s = t.length; o < s; ++o) {
                            var r = t[o];
                    ...
                    nearest: function(t, e) {
                        for (var i, n, o = e.x, s = e.y, r = Number.POSITIVE_INFINITY, a = 0, l = t.length; a < l; ++a) {
                            var c, u = t[a];
                            u && u.hasValue() && (c = u.getCenterPoint(), (c = z.distanceBetweenPoints(e, c)) < r && (r = c, i = u))
                        }
                        return i && (o = (n = i.tooltipPosition()).x, s = n.y), {
                            x: o,
                            y: s
                        }
                    }
            ...
            e.exports = function(t) {
                ...
                e.elements.arc = {
                    ...
                    inRange: function(t, e) {
                        var i = this._view;
                        if (i) {
                            for (var t = r.getAngleFromPoint(i, {
                                    x: t,
                                    y: e
                                }), n = t.angle, e = t.distance, o = i.startAngle, s = i.endAngle; s < o;) s += 2 * Math.PI;
                            for (; s < n;) n -= 2 * Math.PI;
                            for (; n < o;) n += 2 * Math.PI;
                            t = o <= n && n <= s, i = e >= i.innerRadius && e <= i.outerRadius;
                            return t && i
                        }
                        return !1
                    },
                ...
                t.defaults.global.elements.line = {
                    ...
                    draw: function() {
                        ...
                        if (o && u.length && u.push(u[0]), u.length && e.fill) {
                            for (s.beginPath(), r = 0; r < u.length; ++r) a = u[r], l = f.previousItem(u, r), c = a._view, 0 === r ? (o ? s.moveTo(n.x, n.y) : s.moveTo(c.x, n), c.skip || (h = r, s.lineTo(c.x, c.y))) : (l = -1 === h ? l : u[h], c.skip ? i || h !== r - 1 || (o ? s.lineTo(n.x, n.y) : s.lineTo(l._view.x, n)) : (h === r - 1 || i && -1 !== h ? t(l, a) : (o || s.lineTo(c.x, n), s.lineTo(c.x, c.y)), h = r));
                            o || -1 === h || s.lineTo(u[h]._view.x, n), s.fillStyle = e.backgroundColor || p.defaultColor, s.closePath(), s.fill()
                        }
                        var d = p.elements.line;
                        for (s.lineCap = e.borderCapStyle || d.borderCapStyle, s.setLineDash && s.setLineDash(e.borderDash || d.borderDash), s.lineDashOffset = e.borderDashOffset || d.borderDashOffset, s.lineJoin = e.borderJoinStyle || d.borderJoinStyle, s.lineWidth = e.borderWidth || d.borderWidth, s.strokeStyle = e.borderColor || p.defaultColor, s.beginPath(), h = -1, r = 0; r < u.length; ++r) a = u[r], l = f.previousItem(u, r), c = a._view, 0 === r ? c.skip || (s.moveTo(c.x, c.y), h = r) : (l = -1 === h ? l : u[h], c.skip || (h !== r - 1 && !i || -1 === h ? s.moveTo(c.x, c.y) : t(l, a), h = r));
                        s.stroke(), s.restore()
                    }
                })
            }
        ...
        40: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                function o(t) {
                    var e, i, n, o, s = t._view;
                    return o = r(t) ? (n = s.width / 2, e = s.x - n, i = s.x + n, n = Math.min(s.y, s.base), Math.max(s.y, s.base)) : (o = s.height / 2, e = Math.min(s.x, s.base), i = Math.max(s.x, s.base), n = s.y - o, s.y + o), {
                        left: e,
                        top: n,
                        right: i,
                        bottom: o
                ...
                e.elements.rectangle = {
                    ...
                    draw: function() {
                        ...
                        var e, i, n, o, s, r, a, l, c, u = this._chart.ctx,
                            h = this._view,
                            d = h.borderWidth,
                            f = h.horizontal ? (e = h.base, i = h.x, n = h.y - h.height / 2, o = h.y + h.height / 2, a = e < i ? 1 : -1, r = 1, h.borderSkipped || "left") : (e = h.x - h.width / 2, i = h.x + h.width / 2, a = 1, r = (n = h.y) < (o = h.base) ? 1 : -1, h.borderSkipped || "bottom");
                        d && (s = (d = (c = Math.min(Math.abs(e - i), Math.abs(n - o))) < d ? c : d) / 2, l = n + ("top" !== f ? s * r : 0), c = o + ("bottom" !== f ? -s * r : 0), (r = e + ("left" !== f ? s * a : 0)) !== (a = i + ("right" !== f ? -s * a : 0)) && (n = l, o = c), l !== c && (e = r, i = a)), u.beginPath(), u.fillStyle = h.backgroundColor, u.strokeStyle = h.borderColor, u.lineWidth = d;
                        var p = [
                                [e, o],
                                [e, n],
                                [i, n],
                            ...
                            g = ["bottom", "left", "top", "right"].indexOf(f, 0); - 1 === g && (g = 0);
                        var m = t(0);
                        u.moveTo(m[0], m[1]);
                        for (var y = 1; y < 4; y++) m = t(y), u.lineTo(m[0], m[1]);
                        u.fill(), d && u.stroke()
                    },
                    height: function() {
                        var t = this._view;
        ...
        41: [function(t, e, i) {
            ...
            e.exports = function(t) {
                function a(t, e) {
                    e = l.getStyle(t, e), e = e && e.match(/(\d+)px/);
                ...
                function n(t, e, i) {
                    var n, o, s = t._chartjs = {
                        ticking: !1
                    };
                    s.resizer = (n = function() {
                        s.ticking || (s.ticking = !0, l.requestAnimFrame.call(window, function() {
                            if (s.resizer) return s.ticking = !1, e(r("resize", i))
                        }))
                ...
                return {
                    acquireContext: function(t, e) {
                        if ("string" == typeof t ? t = document.getElementById(t) : t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t instanceof HTMLCanvasElement) {
                            ...
                            if (i instanceof CanvasRenderingContext2D) return o = e, r = (n = t).style, e = n.getAttribute("height"), t = n.getAttribute("width"), n._chartjs = {
                                initial: {
                                    height: e,
                                    width: t,
                                    style: {
                            ...
                            }, r.display = r.display || "block", null !== t && "" !== t || void 0 !== (s = a(n, "width")) && (n.width = s), null !== e && "" !== e || ("" === n.style.height ? n.height = n.width / (o.options.aspectRatio || 2) : (o = a(n, "height"), void 0 !== s && (n.height = o))), i
                        }
                        var n, o, s, r;
                        return null
                    },
                    ...
                    addEventListener: function(o, t, s) {
                        var e, i = o.chart.canvas;
                        "resize" !== t ? (e = ((e = s._chartjs || (s._chartjs = {})).proxies || (e.proxies = {}))[o.id + "_" + t] = function(t) {
                            var e, i, n;
                            s((e = t, i = o.chart, n = c[e.type] || e.type, t = l.getRelativePosition(e, i), r(n, i, t.x, t.y, e)))
                        }, l.addEvent(i, t, e)) : n(i.parentNode, s, o.chart)
                    },
                    removeEventListener: function(t, e, i) {
                        var n, o = t.chart.canvas;
                        "resize" !== e ? (n = ((i._chartjs || {}).proxies || {})[t.id + "_" + e]) && l.removeEvent(o, e, n) : (n = o.parentNode) && n._chartjs && ((o = n._chartjs.resizer) && (o.parentNode.removeChild(o), n._chartjs.resizer = null), delete n._chartjs)
                    }
                }
            }
        }, {}],
                ...
                var n = t.helpers,
                    e = t.Scale.extend({
                        ...
                        getPixelForValue: function(t, e, i, n) {
                            var o = this,
                                s = Math.max(o.maxIndex + 1 - o.minIndex - (o.options.gridLines.offsetGridLines ? 0 : 1), 1);
                            if (void 0 !== t && isNaN(e) && (e = -1 !== (r = o.getLabels().indexOf(t)) ? r : e), o.isHorizontal()) {
                                var t = o.width / s,
                                    r = t * (e - o.minIndex);
                                return (o.options.gridLines.offsetGridLines && n || o.maxIndex === o.minIndex && n) && (r += t / 2), o.left + Math.round(r)
                            }
                            s = o.height / s, e = s * (e - o.minIndex);
                            return o.options.gridLines.offsetGridLines && n && (e += s / 2), o.top + Math.round(e)
                        },
                        getPixelForTick: function(t, e) {
                        ...
                        getValueForPixel: function(t) {
                            var e = Math.max(this.ticks.length - (this.options.gridLines.offsetGridLines ? 0 : 1), 1),
                                i = this.isHorizontal(),
                                e = (i ? this.width : this.height) / e;
                            return t -= i ? this.left : this.top, this.options.gridLines.offsetGridLines && (t -= e / 2), t <= 0 ? 0 : Math.round(t / e)
                        },
                        getBasePixel: function() {
                            return this.bottom
                        }
                    ...
                    e = i.LinearScaleBase.extend({
                        determineDataLimits: function() {
                            ...
                            void 0 === n && h.each(t, function(t, e) {
                                var i;
                                n || (i = c.getDatasetMeta(e), c.isDatasetVisible(e) && r(i) && void 0 !== i.stack && (n = !0))
                            }), l.stacked || n ? (u = {}, h.each(t, function(t, e) {
                                var i = c.getDatasetMeta(e),
                                    n = [i.type, void 0 === l.stacked && void 0 === i.stack ? e : "", i.stack].join(".");
                                void 0 === u[n] && (u[n] = {
                                    positiveValues: [],
                                    negativeValues: []
                                });
                                var o = u[n].positiveValues,
                                    s = u[n].negativeValues;
                                c.isDatasetVisible(e) && r(i) && h.each(t.data, function(t, e) {
                                    t = +a.getRightValue(t);
                                    isNaN(t) || i.data[e].hidden || (o[e] = o[e] || 0, s[e] = s[e] || 0, l.relativePoints ? o[e] = 100 : t < 0 ? s[e] += t : o[e] += t)
                                })
                            }), h.each(u, function(t) {
                                var e = t.positiveValues.concat(t.negativeValues),
                                    t = h.min(e),
                                    e = h.max(e);
                                a.min = null === a.min ? t : Math.min(a.min, t), a.max = null === a.max ? e : Math.max(a.max, e)
                            })) : h.each(t, function(t, e) {
                                var i = c.getDatasetMeta(e);
                                c.isDatasetVisible(e) && r(i) && h.each(t.data, function(t, e) {
                                    t = +a.getRightValue(t);
                                    isNaN(t) || i.data[e].hidden || ((null === a.min || t < a.min) && (a.min = t), (null === a.max || t > a.max) && (a.max = t))
                                })
                            }), this.handleTickRangeOptions()
                        },
                        getTickLimit: function() {
                            var t, e = this.options.ticks;
                            return this.isHorizontal() ? Math.min(e.maxTicksLimit || 11, Math.ceil(this.width / 50)) : (t = h.getValueOrDefault(e.fontSize, i.defaults.global.defaultFontSize), Math.min(e.maxTicksLimit || 11, Math.ceil(this.height / (2 * t))))
                        },
                        ...
                        getPixelForValue: function(t) {
                            var e = this.start,
                                ...
                                t = this.end - e,
                                e = this.isHorizontal() ? this.left + this.width / t * (i - e) : this.bottom - this.height / t * (i - e);
                            return Math.round(e)
                        },
                        getValueForPixel: function(t) {
                            var e = this.isHorizontal(),
                                i = e ? this.width : this.height,
                                i = (e ? t - this.left : this.bottom - t) / i;
            ...
            e.exports = function(n) {
                ...
                n.LinearScaleBase = n.Scale.extend({
                    handleTickRangeOptions: function() {
                        var t, e, i = this,
                            n = i.options.ticks;
                        n.beginAtZero && (t = o.sign(i.min), e = o.sign(i.max), t < 0 && e < 0 ? i.max = 0 : 0 < t && 0 < e && (i.min = 0)), void 0 !== n.min ? i.min = n.min : void 0 !== n.suggestedMin && (i.min = Math.min(i.min, n.suggestedMin)), void 0 !== n.max ? i.max = n.max : void 0 !== n.suggestedMax && (i.max = Math.max(i.max, n.suggestedMax)), i.min === i.max && (i.max++, n.beginAtZero || i.min--)
                    },
                    getTickLimit: t,
                    ...
                    buildTicks: function() {
                        var t = this,
                            ...
                            i = {
                                ...
                                min: e.min,
                                max: e.max,
                                stepSize: o.getValueOrDefault(e.fixedStepSize, e.stepSize)
                            },
                            i = t.ticks = n.Ticks.generators.linear(i, t);
                    ...
                    convertTicksToLabels: function() {
                        this.ticksAsNumbers = this.ticks.slice(), this.zeroLineIndex = this.ticks.indexOf(0), n.Scale.prototype.convertTicksToLabels.call(this)
                    }
                })
            }
        }, {}],
            ...
            e.exports = function(n) {
                var u = n.helpers,
                    t = {
                        position: "left",
                        ticks: {
                            callback: n.Ticks.formatters.logarithmic
                        }
                    },
                    e = n.Scale.extend({
                        determineDataLimits: function() {
                            ...
                            var c, o = a.stacked;
                            void 0 === o && u.each(e, function(t, e) {
                                var i;
                                o || (i = l.getDatasetMeta(e), l.isDatasetVisible(e) && s(i) && void 0 !== i.stack && (o = !0))
                            }), a.stacked || o ? (c = {}, u.each(e, function(t, e) {
                                var n = l.getDatasetMeta(e),
                                    o = [n.type, void 0 === a.stacked && void 0 === n.stack ? e : "", n.stack].join(".");
                                l.isDatasetVisible(e) && s(n) && (void 0 === c[o] && (c[o] = []), u.each(t.data, function(t, e) {
                                    var i = c[o],
                                        t = +r.getRightValue(t);
                                    isNaN(t) || n.data[e].hidden || (i[e] = i[e] || 0, a.relativePoints ? i[e] = 100 : i[e] += t)
                                }))
                            }), u.each(c, function(t) {
                                var e = u.min(t),
                                    t = u.max(t);
                                r.min = null === r.min ? e : Math.min(r.min, e), r.max = null === r.max ? t : Math.max(r.max, t)
                            })) : u.each(e, function(t, e) {
                                var i = l.getDatasetMeta(e);
                                l.isDatasetVisible(e) && s(i) && u.each(t.data, function(t, e) {
                                    t = +r.getRightValue(t);
                                    isNaN(t) || i.data[e].hidden || ((null === r.min || t < r.min) && (r.min = t), (null === r.max || t > r.max) && (r.max = t), 0 != t && (null === r.minNotZero || t < r.minNotZero) && (r.minNotZero = t))
                                })
                        ...
                        buildTicks: function() {
                            var t = this,
                                ...
                                i = t.ticks = n.Ticks.generators.logarithmic(i, t);
                            t.isHorizontal() || i.reverse(), t.max = u.max(i), t.min = u.min(i), e.reverse ? (i.reverse(), t.start = t.max, t.end = t.min) : (t.start = t.min, t.end = t.max)
                        },
                        convertTicksToLabels: function() {
                        ...
                        getPixelForValue: function(t) {
                            var e, i, n = this,
                                ...
                                s = +n.getRightValue(t),
                                t = n.options.ticks,
                                n = n.isHorizontal() ? (i = u.log10(n.end) - u.log10(o), 0 == s ? n.left : (e = n.width, n.left + e / i * (u.log10(s) - u.log10(o)))) : (e = n.height, 0 !== o || t.reverse ? 0 === n.end && t.reverse ? (i = u.log10(n.start) - u.log10(n.minNotZero), s === n.end ? n.top : s === n.minNotZero ? n.top + .02 * e : n.top + .02 * e + .98 * e / i * (u.log10(s) - u.log10(n.minNotZero))) : (i = u.log10(n.end) - u.log10(o), e = n.height, n.bottom - e / i * (u.log10(s) - u.log10(o))) : (i = u.log10(n.end) - u.log10(n.minNotZero), s === o ? n.bottom : s === n.minNotZero ? n.bottom - .02 * e : n.bottom - .02 * e - .98 * e / i * (u.log10(s) - u.log10(n.minNotZero))));
                            return n
                        },
                        getValueForPixel: function(t) {
                            var e = u.log10(this.end) - u.log10(this.start),
                                i = this.isHorizontal() ? (i = this.width, this.start * Math.pow(10, (t - this.left) * e / i)) : (i = this.height, Math.pow(10, (this.bottom - t) * e / i) / this.start);
                            return i
                        }
                    });
            ...
            e.exports = function(t) {
                ...
                function p(t) {
                    var e = t.options.pointLabels,
                        i = g.getValueOrDefault(e.fontSize, m.defaultFontSize),
                        t = g.getValueOrDefault(e.fontStyle, m.defaultFontStyle),
                        e = g.getValueOrDefault(e.fontFamily, m.defaultFontFamily);
                    return {
                        size: i,
                        style: t,
                        family: e,
                        font: g.fontString(i, t, e)
                    }
                }
                ...
                function i(t) {
                    ...
                    for (var r = f(t), a = 0; a < r; a++) {
                        e = t.getPointPosition(a, n), l = t.ctx, u = i.size, c = t.pointLabels[a] || "", h = g.isArray(c) ? {
                            w: g.longestText(l, l.font, c),
                            h: c.length * u + 1.5 * (c.length - 1) * u
                        } : {
                            w: l.measureText(c).width,
                            h: u
                        }, t._pointLabelSizes[a] = h;
                        var l = t.getIndexAngle(a),
                            c = g.toDegrees(l) % 360,
                            u = d(c, e.x, h.w, 0, 180),
                            h = d(c, e.y, h.h, 90, 270);
                        u.start < o.l && (o.l = u.start, s.l = l), u.end > o.r && (o.r = u.end, s.r = l), h.start < o.t && (o.t = h.start, s.t = l), h.end > o.b && (o.b = h.end, s.b = l)
                    }
                    t.setReductions(n, o, s)
                }
                ...
                function n(t) {
                    ...
                    var r = t.getDistanceFromCenterForValue(n.reverse ? t.min : t.max),
                        a = p(t);
                    e.textBaseline = "top";
                    for (var l = f(t) - 1; 0 <= l; l--) {
                        o.display && (d = t.getPointPosition(l, r), e.beginPath(), e.moveTo(t.xCenter, t.yCenter), e.lineTo(d.x, d.y), e.stroke(), e.closePath());
                        var c = t.getPointPosition(l, r + 5),
                            u = i(s.fontColor, m.defaultFontColor);
                        e.font = a.font, e.fillStyle = u;
                        var h = t.getIndexAngle(l),
                            d = g.toDegrees(h);
                        e.textAlign = 0 === (u = d) || 180 === u ? "center" : u < 180 ? "left" : "right", h = d, u = t._pointLabelSizes[l], d = c, 90 === h || 270 === h ? d.y -= u.h / 2 : (270 < h || h < 90) && (d.y -= u.h),
                            function(t, e, i, n) {
                                if (g.isArray(e))
                                    for (var o = i.y, s = 1.5 * n, r = 0; r < e.length; ++r) t.fillText(e[r], i.x, o), o += s;
                                else t.fillText(e, i.x, i.y)
                            }(e, t.pointLabels[l] || "", c, a.size)
                    }
                }

                function r(t) {
                    return g.isNumber(t) ? t : 0
                }
                var g = t.helpers,
                    m = t.defaults.global,
                    e = {
                    ...
                    o = t.LinearScaleBase.extend({
                        setDimensions: function() {
                            ...
                            var n = g.min([t.height, t.width]),
                                o = g.getValueOrDefault(i.fontSize, m.defaultFontSize);
                        ...
                        determineDataLimits: function() {
                            ...
                            g.each(o.data.datasets, function(t, e) {
                                var i;
                                o.isDatasetVisible(e) && (i = o.getDatasetMeta(e), g.each(t.data, function(t, e) {
                                    t = +n.getRightValue(t);
                                    isNaN(t) || i.data[e].hidden || (s = Math.min(t, s), r = Math.max(t, r))
                                }))
                            }), n.min = s === Number.POSITIVE_INFINITY ? 0 : s, n.max = r === Number.NEGATIVE_INFINITY ? 0 : r, n.handleTickRangeOptions()
                        },
                        getTickLimit: function() {
                            var t = this.options.ticks,
                                e = g.getValueOrDefault(t.fontSize, m.defaultFontSize);
                        ...
                        setReductions: function(t, e, i) {
                            var n = e.l / Math.sin(i.l),
                                ...
                                s = -e.t / Math.cos(i.t),
                                i = -Math.max(e.b - this.height, 0) / Math.cos(i.b),
                                n = r(n),
                                o = r(o),
                                s = r(s),
                                i = r(i);
                            this.drawingArea = Math.min(Math.round(t - (n + o) / 2), Math.round(t - (s + i) / 2)), this.setCenterPoint(n, o, s, i)
                        },
                        setCenterPoint: function(t, e, i, n) {
                            var o = this,
                                e = o.width - e - o.drawingArea,
                                t = t + o.drawingArea,
                                i = i + o.drawingArea,
                        ...
                        draw: function() {
                            var o, s, t, e, r, a = this,
                                l = a.options,
                                c = l.gridLines,
                                u = l.ticks,
                                h = g.getValueOrDefault;
                            l.display && (o = a.ctx, s = h(u.fontSize, m.defaultFontSize), t = h(u.fontStyle, m.defaultFontStyle), e = h(u.fontFamily, m.defaultFontFamily), r = g.fontString(s, t, e), g.each(a.ticks, function(t, e) {
                                var i, n;
                                (0 < e || l.reverse) && (n = a.getDistanceFromCenterForValue(a.ticksAsNumbers[e]), i = a.yCenter - n, c.display && 0 !== e && function(t, e, i, n) {
                                    var o = t.ctx;
                                    if (o.strokeStyle = g.getValueAtIndexOrDefault(e.color, n - 1), o.lineWidth = g.getValueAtIndexOrDefault(e.lineWidth, n - 1), t.options.lineArc) o.beginPath(), o.arc(t.xCenter, t.yCenter, i, 0, 2 * Math.PI), o.closePath(), o.stroke();
                                    else {
                                        var s = f(t);
                                        if (0 !== s) {
                                            o.beginPath();
                                            ...
                                            o.moveTo(r.x, r.y);
                                            for (var a = 1; a < s; a++) r = t.getPointPosition(a, i), o.lineTo(r.x, r.y);
                                            o.closePath(), o.stroke()
                                        }
                                    }
                                }(a, c, n, e), u.display && (n = h(u.fontColor, m.defaultFontColor), o.font = r, u.showLabelBackdrop && (e = o.measureText(t).width, o.fillStyle = u.backdropColor, o.fillRect(a.xCenter - e / 2 - u.backdropPaddingX, i - s / 2 - u.backdropPaddingY, e + 2 * u.backdropPaddingX, s + 2 * u.backdropPaddingY)), o.textAlign = "center", o.textBaseline = "middle", o.fillStyle = n, o.fillText(t, a.xCenter, i)))
                            }), l.lineArc || n(a))
                        }
                    });
                t.scaleService.registerScaleType("radialLinear", o, e)
            }
        }, {}],
        48: [function(t, e, i) {
            "use strict";
                ...
                var g = p.helpers,
                    ...
                    t = p.Scale.extend({
                        initialize: function() {
                            ...
                            p.Scale.prototype.initialize.call(this)
                        },
                        ...
                        determineDataLimits: function() {
                            ...
                            o.labelMoments = [];
                            var s = [];
                            o.chart.data.labels && 0 < o.chart.data.labels.length ? (g.each(o.chart.data.labels, function(t) {
                                t = o.parseTime(t);
                                t.isValid() && (o.options.time.round && t.startOf(o.options.time.round), s.push(t))
                            }, o), o.firstTick = r.min.call(o, s), o.lastTick = r.max.call(o, s)) : (o.firstTick = null, o.lastTick = null), g.each(o.chart.data.datasets, function(t, e) {
                                var i = [],
                                    n = o.chart.isDatasetVisible(e);
                                "object" == typeof t.data[0] && null !== t.data[0] ? g.each(t.data, function(t) {
                                    t = o.parseTime(o.getRightValue(t));
                                    t.isValid() && (o.options.time.round && t.startOf(o.options.time.round), i.push(t), n && (o.firstTick = null !== o.firstTick ? r.min(o.firstTick, t) : t, o.lastTick = null !== o.lastTick ? r.max(o.lastTick, t) : t))
                                }, o) : i = s, o.labelMoments.push(i)
                            }, o), o.options.time.min && (o.firstTick = o.parseTime(o.options.time.min)), o.options.time.max && (o.lastTick = o.parseTime(o.options.time.max)), o.firstTick = (o.firstTick || r()).clone(), o.lastTick = (o.lastTick || r()).clone()
                        },
                        buildLabelDiffs: function() {
                            var i = this;
                            i.labelDiffs = [];
                            var n = [];
                            i.chart.data.labels && 0 < i.chart.data.labels.length && g.each(i.chart.data.labels, function(t) {
                                t = i.parseTime(t);
                                t.isValid() && (i.options.time.round && t.startOf(i.options.time.round), n.push(t.diff(i.firstTick, i.tickUnit, !0)))
                            }, i), g.each(i.chart.data.datasets, function(t) {
                                var e = [];
                                "object" == typeof t.data[0] && null !== t.data[0] ? g.each(t.data, function(t) {
                                    t = i.parseTime(i.getRightValue(t));
                                    t.isValid() && (i.options.time.round && t.startOf(i.options.time.round), e.push(t.diff(i.firstTick, i.tickUnit, !0)))
                                }, i) : e = n, i.labelDiffs.push(e)
                            }, i)
                        },
                        buildTicks: function() {
                            var t = this;
                            t.ctx.save();
                            var e = g.getValueOrDefault(t.options.ticks.fontSize, p.defaults.global.defaultFontSize),
                                i = g.getValueOrDefault(t.options.ticks.fontStyle, p.defaults.global.defaultFontStyle),
                                n = g.getValueOrDefault(t.options.ticks.fontFamily, p.defaults.global.defaultFontFamily),
                                n = g.fontString(e, i, n);
                            if (t.ctx.font = n, t.ticks = [], t.unitScale = 1, t.scaleSizeInUnits = 0, t.options.time.unit) t.tickUnit = t.options.time.unit || "day", t.displayFormat = t.options.time.displayFormats[t.tickUnit], t.scaleSizeInUnits = t.lastTick.diff(t.firstTick, t.tickUnit, !0), t.unitScale = g.getValueOrDefault(t.options.time.unitStepSize, 1);
                            else {
                                var n = t.isHorizontal() ? t.width : t.height,
                                    o = t.tickFormatFunction(t.firstTick, 0, []),
                                    s = n / (t.ctx.measureText(o).width * Math.cos(g.toRadians(t.options.ticks.maxRotation)) + e * Math.sin(g.toRadians(t.options.ticks.maxRotation)));
                                ...
                                for (var r = 0, a = m.units[r]; r < m.units.length;) {
                                    if (t.unitScale = 1, g.isArray(a.steps) && Math.ceil(t.scaleSizeInUnits / s) < g.max(a.steps)) {
                                        for (var l = 0; l < a.steps.length; ++l)
                                            if (a.steps[l] >= Math.ceil(t.scaleSizeInUnits / s)) {
                                                t.unitScale = g.getValueOrDefault(t.options.time.unitStepSize, a.steps[l]);
                                                break
                                            }
                                        break
                                    }
                                    if (!1 === a.maxStep || Math.ceil(t.scaleSizeInUnits / s) < a.maxStep) {
                                        t.unitScale = g.getValueOrDefault(t.options.time.unitStepSize, Math.ceil(t.scaleSizeInUnits / s));
                                        break
                                    }
                                    a = m.units[++r], t.tickUnit = a.name;
                                    ...
                                    t.scaleSizeInUnits = t.lastTick.diff(t.firstTick, t.tickUnit, !0) + c + u, t.displayFormat = t.options.time.displayFormats[a.name]
                                }
                            }
                            var h = t.options.time.min ? t.getMomentStartOf(t.firstTick) : (t.firstTick = t.getMomentStartOf(t.firstTick), t.firstTick);
                            t.options.time.max || ((e = (o = t.getMomentStartOf(t.lastTick)).diff(t.lastTick, t.tickUnit, !0)) < 0 ? t.lastTick = t.getMomentStartOf(t.lastTick.add(1, t.tickUnit)) : 0 <= e && (t.lastTick = o), t.scaleSizeInUnits = t.lastTick.diff(t.firstTick, t.tickUnit, !0)), t.options.time.displayFormat && (t.displayFormat = t.options.time.displayFormat), t.ticks.push(t.firstTick.clone());
                            for (var d = t.unitScale; d <= t.scaleSizeInUnits; d += t.unitScale) {
                                var f = h.clone().add(d, t.tickUnit);
                                if (t.options.time.max && 0 <= f.diff(t.lastTick, t.tickUnit, !0)) break;
                                t.ticks.push(f)
                            }
                        ...
                        getLabelForIndex: function(t, e) {
                            var i = this.chart.data.labels && t < this.chart.data.labels.length ? this.chart.data.labels[t] : "",
                                t = this.chart.data.datasets[e].data[t];
                            return null !== t && "object" == typeof t && (i = this.getRightValue(t)), this.options.time.tooltipFormat && (i = this.parseTime(i).format(this.options.time.tooltipFormat)), i
                        },
                        tickFormatFunction: function(t, e, i) {
                            var n = t.format(this.displayFormat),
                                t = this.options.ticks,
                                t = g.getValueOrDefault(t.callback, t.userCallback);
                            return t ? t(n, e, i) : n
                        },
                        convertTicksToLabels: function() {
                        ...
                        getPixelForValue: function(t, e, i) {
                            ...
                            if (void 0 !== e && void 0 !== i && (o = n.getLabelDiff(i, e)), null === o && (t && t.isValid || (t = n.parseTime(n.getRightValue(t))), t && t.isValid && t.isValid() && (o = t.diff(n.firstTick, n.tickUnit, !0))), null !== o) {
                                t = 0 !== o ? o / n.scaleSizeInUnits : o;
                                if (n.isHorizontal()) {
                                    o = n.width * t;
                                    return n.left + Math.round(o)
                                }
                                t = n.height * t;
                                return n.top + Math.round(t)
                            }
                        },
                        getPixelForTick: function(t) {
                        ...
                        getValueForPixel: function(t) {
                            var e = this.isHorizontal() ? this.width : this.height,
                                e = (t - (this.isHorizontal() ? this.left : this.top)) / e;
                            return e *= this.scaleSizeInUnits, this.firstTick.clone().add(r.duration(e, this.tickUnit).asSeconds(), "seconds")
                        },
                        parseTime: function(t) {
                            return "string" == typeof this.options.time.parser ? r(t, this.options.time.parser) : "function" == typeof this.options.time.parser ? this.options.time.parser(t) : "function" == typeof t.getMonth || "number" == typeof t ? r(t) : t.isValid && t.isValid() ? t : "string" != typeof this.options.time.format && this.options.time.format.call ? (console.warn("options.time.format is deprecated and replaced by options.time.parser. See http://nnnick.github.io/Chart.js/docs-v2/#scales-time-scale"), this.options.time.format(t)) : r(t, this.options.time.format)
                        }
                    });
                p.scaleService.registerScaleType("time", t, {
                    position: "bottom",
                    time: {
                        parser: !1,
                        format: !1,
...
function(n) {
    ...
    e.Defaults = {
...
}(window.Zepto || window.jQuery, (window, document)), jQuery(document).ready(function(r) {
        var a = 2500,
            s = 3800,
            l = s - 3e3,
            o = 50,
        ...
        function f(t) {
            ...
            t.parents(".cd-headline").hasClass("type") ? ((e = t.parent(".cd-words-wrapper")).addClass("selected").removeClass("waiting"), setTimeout(function() {
                ...
                e.is(":last-child") ? n && setTimeout(function() {
                    ...
                    var s;
                    e.is(":last-child") && r("html").hasClass("no-csstransitions") && (s = m(i), y(i, s))
                }
        ...
        r(".cd-headline.letters").find("b").each(function() {
            ...
            function(t) {
                ...
                t.each(function() {
                    var t, e, i, n = r(this);
                    n.hasClass("loading-bar") ? (o = s, setTimeout(function() {
    ...
    function() {
        ...
        u.prototype.extend = function(t, e) {
        ...
        }, u.prototype.createEvent = function(t, e, i, n) {
            var o;
            ...
            for (var i, n, o = i = 0, s = (n = this.keys).length; i < s; o = ++i)
                if (n[o] === t) return void(this.values[o] = e);
            return this.keys.push(t), this.values.push(e)
        }, c), n = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver || (a.notSupported = !0, a.prototype.observe = function() {}, a), l = this.getComputedStyle || function(i, t) {
            ...
            return this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live ? new n((r = this, function(t) {
                for (var o, s, e = [], i = 0, n = t.length; i < n; i++) s = t[i], e.push(function() {
                    for (var t, e = [], i = 0, n = (t = s.addedNodes || []).length; i < n; i++) o = t[i], e.push(this.doSync(o));
                    return e
                }.call(r));
                return e
            ...
            for (s in t) r = t[s], o["" + s] = r, e.push(function() {
                for (var t, e = [], i = 0, n = (t = this.vendors).length; i < n; i++) a = t[i], e.push(o["" + a + s.charAt(0).toUpperCase() + s.substr(1)] = r);
                return e
            }.call(this));
            return e
        }, s.prototype.vendorCSS = function(t, e) {
            for (var i, n, o, s = (n = l(t)).getPropertyCSSValue(e), r = 0, a = (i = this.vendors).length; r < a; r++) o = i[r], s = s || n.getPropertyCSSValue("-" + o + "-" + e);
            return s
...
! function(i) {
    ...
    return u.fn.tilt = function(e) {
        ...
        function n() {
            var t = this;
            void 0 !== this.timeout && clearTimeout(this.timeout), u(this).css({
        ...
        var r = function(t) {
                this.ticking = !1, u(this).css({
                    "will-change": "transform"
                }), n.call(this), u(this).trigger("tilt.mouseEnter")
            },
            a = function(t) {
                this.mousePositions = o(t), i.call(this)
            },
            l = function() {
                n.call(this), this.reset = !0, i.call(this), u(this).trigger("tilt.mouseLeave")
            },
            t = function() {
                return this.transforms = s.call(this), this.reset ? (this.reset = !1, u(this).css("transform", "perspective(" + this.settings.perspective + "px) rotateX(0deg) rotateY(0deg)"), void(this.settings.glare && (this.glareElement.css("transform", "rotate(180deg) translate(-50%, -50%)"), this.glareElement.css("opacity", "0")))) : (u(this).css("transform", "perspective(" + this.settings.perspective + "px) rotateX(" + ("x" === this.settings.disableAxis ? 0 : this.transforms.tiltY) + "deg) rotateY(" + ("y" === this.settings.disableAxis ? 0 : this.transforms.tiltX) + "deg) scale3d(" + this.settings.scale + "," + this.settings.scale + "," + this.settings.scale + ")"), this.settings.glare && (this.glareElement.css("transform", "rotate(" + this.transforms.angle + "deg) translate(-50%, -50%)"), this.glareElement.css("opacity", "" + this.transforms.percentageY * this.settings.maxGlare / 100)), u(this).trigger("change", [this.transforms]), void(this.ticking = !1))
            },
            c = function() {
        ...
        return u.fn.tilt.destroy = function() {
            u(this).each(function() {
                u(this).find(".js-tilt-glare").remove(), u(this).css({
                    "will-change": "",
                    transform: ""
            ...
            return u(this).each(function() {
                this.mousePositions = o.call(this), t.push(s.call(this))
            }), t
        }, u.fn.tilt.reset = function() {
            u(this).each(function() {
                var t = this;
                this.mousePositions = o.call(this), this.settings = u(this).data("settings"), l.call(this), setTimeout(function() {
                    t.reset = !1
            ...
            this.settings = u.extend({
                maxTilt: u(this).is("[data-tilt-max]") ? u(this).data("tilt-max") : 20,
                perspective: u(this).is("[data-tilt-perspective]") ? u(this).data("tilt-perspective") : 300,
                easing: u(this).is("[data-tilt-easing]") ? u(this).data("tilt-easing") : "cubic-bezier(.03,.98,.52,.99)",
                scale: u(this).is("[data-tilt-scale]") ? u(this).data("tilt-scale") : "1",
                speed: u(this).is("[data-tilt-speed]") ? u(this).data("tilt-speed") : "400",
                transition: !u(this).is("[data-tilt-transition]") || u(this).data("tilt-transition"),
                disableAxis: u(this).is("[data-tilt-disable-axis]") ? u(this).data("tilt-disable-axis") : null,
                axis: u(this).is("[data-tilt-axis]") ? u(this).data("tilt-axis") : null,
                reset: !u(this).is("[data-tilt-reset]") || u(this).data("tilt-reset"),
                glare: !!u(this).is("[data-tilt-glare]") && u(this).data("tilt-glare"),
                maxGlare: u(this).is("[data-tilt-maxglare]") ? u(this).data("tilt-maxglare") : 1
                ...
                u(t).data("settings", t.settings), t.settings.glare && function() {
                        var t = this.settings.glarePrerender;
                        t || u(this).append('<div class="js-tilt-glare"><div class="js-tilt-glare-inner"></div></div>'), this.glareElementWrapper = u(this).find(".js-tilt-glare"), this.glareElement = u(this).find(".js-tilt-glare-inner"), t || (this.glareElementWrapper.css({
                            position: "absolute",
                            top: "0",
                            left: "0",
                            width: "100%",
                    ...
                    function() {
                        u(this).on("mousemove", a), u(this).on("mouseenter", r), this.settings.reset && u(this).on("mouseleave", l), this.settings.glare && u(window).on("resize", c.bind(this))
                    }.call(t)
            }, this.init()
        })
    }, u("[data-tilt]").tilt(), !0
...
function(t, e) {
    ...
    ! function() {
        ...
        e.prototype.init = function() {
            ...
            p("body").append(n), this.$outer = p(".lg-outer"), this.$outer.focus(), this.$slide = this.$outer.find(".lg-item"), this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), o.setTop(), p(window).on("resize.lg orientationchange.lg", function() {
                setTimeout(function() {
                    o.setTop()
                }, 100)
            ...
            }, this.s.backdropDuration), this.s.download && this.$outer.find(".lg-toolbar").append('<a id="lg-download" aria-label="Download" target="_blank" download class="lg-download lg-icon"></a>'), this.prevScrollTop = p(window).scrollTop()
            ...
            this.s.counter && p(this.s.appendCounterTo).append('<div id="lg-counter" role="status" aria-live="polite"><span id="lg-counter-current">' + (parseInt(this.index, 10) + 1) + '</span> / <span id="lg-counter-all">' + this.$items.length + "</span></div>")
        }, e.prototype.addHtml = function(t) {
            var e, i, n, o = null;
            this.s.dynamic ? this.s.dynamicEl[t].subHtmlUrl ? e = this.s.dynamicEl[t].subHtmlUrl : o = this.s.dynamicEl[t].subHtml : (i = this.$items.eq(t)).attr("data-sub-html-url") ? e = i.attr("data-sub-html-url") : (o = i.attr("data-sub-html"), this.s.getCaptionFromTitleOrAlt && !o && (o = i.attr("title") || i.find("img").first().attr("alt"))), e || (null != o ? "." !== (n = o.substring(0, 1)) && "#" !== n || (o = (this.s.subHtmlSelectorRelative && !this.s.dynamic ? i.find(o) : p(o)).html()) : o = ""), ".lg-sub-html" === this.s.appendSubHtmlTo ? e ? this.$outer.find(this.s.appendSubHtmlTo).load(e) : this.$outer.find(this.s.appendSubHtmlTo).html(o) : e ? this.$slide.eq(t).load(e) : this.$slide.eq(t).append(o), null != o && ("" === o ? this.$outer.find(this.s.appendSubHtmlTo).addClass("lg-empty-html") : this.$outer.find(this.s.appendSubHtmlTo).removeClass("lg-empty-html")), this.$el.trigger("onAfterAppendSubHtml.lg", [t])
            ...
            }), f && f.html5 && !u && c.$slide.eq(e).addClass("lg-complete"), !0 === t && (c.$slide.eq(e).hasClass("lg-complete") ? c.preload(e) : c.$slide.eq(e).find(".lg-object").on("load.lg error.lg", function() {
                c.preload(e)
            }))
        }, e.prototype.slide = function(t, e, i, n) {
            var o, s, r, a, l, c = this.$outer.find(".lg-current").index(),
                u = this;
            u.lGalleryOn && c === t || (o = this.$slide.length, s = u.lGalleryOn ? this.s.speed : 0, u.lgBusy || (this.s.download && ((r = u.s.dynamic ? !1 !== u.s.dynamicEl[t].downloadUrl && (u.s.dynamicEl[t].downloadUrl || u.s.dynamicEl[t].src) : "false" !== u.$items.eq(t).attr("data-download-url") && (u.$items.eq(t).attr("data-download-url") || u.$items.eq(t).attr("href") || u.$items.eq(t).attr("data-src"))) ? (p("#lg-download").attr("href", r), u.$outer.removeClass("lg-hide-download")) : u.$outer.addClass("lg-hide-download")), this.$el.trigger("onBeforeSlide.lg", [c, t, e, i]), u.lgBusy = !0, clearTimeout(u.hideBarTimeout), ".lg-sub-html" === this.s.appendSubHtmlTo && setTimeout(function() {
                u.addHtml(t)
            }, s), this.arrowDisable(t), n || (t < c ? n = "prev" : c < t && (n = "next")), e ? (this.$slide.removeClass("lg-prev-slide lg-current lg-next-slide"), 2 < o ? (a = t - 1, l = t + 1, (0 === t && c === o - 1 || t === o - 1 && 0 === c) && (l = 0, a = o - 1)) : (a = 0, l = 1), "prev" === n ? u.$slide.eq(l).addClass("lg-next-slide") : u.$slide.eq(a).addClass("lg-prev-slide"), u.$slide.eq(t).addClass("lg-current")) : (u.$outer.addClass("lg-no-trans"), this.$slide.removeClass("lg-prev-slide lg-next-slide"), "prev" === n ? (this.$slide.eq(t).addClass("lg-prev-slide"), this.$slide.eq(c).addClass("lg-next-slide")) : (this.$slide.eq(t).addClass("lg-next-slide"), this.$slide.eq(c).addClass("lg-prev-slide")), setTimeout(function() {
            ...
            }, this.s.speed)) : (u.loadContent(t, !0, u.s.backdropDuration), u.lgBusy = !1, u.$el.trigger("onAfterSlide.lg", [c, t, e, i])), u.lGalleryOn = !0, this.s.counter && p("#lg-counter-current").text(t + 1)), u.index = t)
            ...
            e.s.enableDrag && e.doCss() && (e.$slide.on("mousedown.lg", function(t) {
                e.$outer.hasClass("lg-zoomed") || e.lgBusy || p(t.target).text().trim() || (t.preventDefault(), e.manageSwipeClass(), i = t.pageX, o = !0, e.$outer.scrollLeft += 1, --e.$outer.scrollLeft, e.$outer.removeClass("lg-grab").addClass("lg-grabbing"), e.$el.trigger("onDragstart.lg"))
                ...
                s ? (s = !1, e.touchEnd(n - i), e.$el.trigger("onDragend.lg")) : (p(t.target).hasClass("lg-object") || p(t.target).hasClass("lg-video-play")) && e.$el.trigger("onSlideClick.lg"), o && (o = !1, e.$outer.removeClass("lg-grabbing").addClass("lg-grab"))
            }))
            ...
            t || (e.$el.trigger("onBeforeClose.lg"), p(window).scrollTop(e.prevScrollTop)), t && (e.s.dynamic || this.$items.off("click.lg click.lgcustom"), p.removeData(e.el, "lightGallery")), this.$el.off(".lg.tm"), p.each(p.fn.lightGallery.modules, function(t) {
                ...
                e.$outer && e.$outer.remove(), p(".lg-backdrop").remove(), t || e.$el.trigger("onCloseAfter.lg"), e.$el.focus()
...
function(t, e) {
    ...
    ! function() {
        ...
        t.prototype.init = function() {
            ...
            o.core.$outer.find(".lg-thumb").html(s), (t = o.core.$outer.find(".lg-thumb-item")).each(function() {
                var e = a(this),
            ...
            e.$thumbOuter.addClass("lg-grab"), e.core.$outer.find(".lg-thumb").on("mousedown.lg.thumb", function(t) {
                ...
                o && (r = e.left, s = !0, n = t.pageX, e.$thumbOuter.addClass("lg-dragging"), (r -= n - i) > e.thumbTotalWidth - e.thumbOuterWidth && (r = e.thumbTotalWidth - e.thumbOuterWidth), r < 0 && (r = 0), e.setTranslate(r))
            ...
            e.core.$outer.find(".lg-thumb").on("touchstart.lg", function(t) {
                ...
                e.thumbTotalWidth > e.thumbOuterWidth && (t.preventDefault(), n = t.originalEvent.targetTouches[0].pageX, o = !0, e.$thumbOuter.addClass("lg-dragging"), s = e.left, (s -= n - i) > e.thumbTotalWidth - e.thumbOuterWidth && (s = e.thumbTotalWidth - e.thumbOuterWidth), s < 0 && (s = 0), e.setTranslate(s))
            }), e.core.$outer.find(".lg-thumb").on("touchend.lg", function() {
                e.thumbTotalWidth > e.thumbOuterWidth && o ? (o = !1, e.$thumbOuter.removeClass("lg-dragging"), Math.abs(n - i) < e.core.s.swipeThreshold && (e.thumbClickable = !0), e.left = s) : e.thumbClickable = !0
            })
    ...
    ! function() {
        ...
        t.prototype.init = function() {
            ...
            n.core.$el.on("hasVideo.lg.tm", function(t, e, i, n) {
                ...
                n.loadVideoOnclick(l(this))
            }), n.core.$el.on("onBeforeSlide.lg.tm", function(t, e, i) {
                var n = this.core.$slide.eq(e),
                    o = n.find(".lg-youtube").get(0),
                    s = n.find(".lg-vimeo").get(0),
                    r = n.find(".lg-dailymotion").get(0),
                    e = n.find(".lg-vk").get(0),
                    a = n.find(".lg-html5").get(0);
                ...
                e = this.core.s.dynamic ? this.core.s.dynamicEl[i].src : this.core.$items.eq(i).attr("href") || this.core.$items.eq(i).attr("data-src");
                i = this.core.isVideo(e, i) || {};
                (i.youtube || i.vimeo || i.dailymotion || i.vk) && this.core.$outer.addClass("lg-hide-download")
    ...
    ! function() {
        ...
        t.prototype.init = function() {
            ...
            s.core.s.actualSize && (t += '<button type="button" aria-label="Actual size" id="lg-actual-size" class="lg-icon"></button>'), s.core.s.useLeftForZoom ? s.core.$outer.addClass("lg-use-left-for-zoom") : s.core.$outer.addClass("lg-use-transition-for-zoom"), this.core.$outer.find(".lg-toolbar").append(t), s.core.$el.on("onSlideItemLoad.lg.tm.zoom", function(t, e, i) {
                var n = s.core.s.enableZoomAfter + i;
                d("body").hasClass("lg-from-hash") && i ? n = 0 : d("body").removeClass("lg-from-hash"), s.zoomabletimeout = setTimeout(function() {
            ...
            function n(t, e, i, n) {
                var o = e.prop("offsetWidth"),
                    e = s.core.s.dynamic ? s.core.s.dynamicEl[i].width || e[0].naturalWidth || o : s.core.$items.eq(i).attr("data-width") || e[0].naturalWidth || o;
                s.core.$outer.hasClass("lg-zoomed") ? a = 1 : o < e && (a = e / o || 2), n ? (s.pageX = d(window).width() / 2, s.pageY = d(window).height() / 2 + d(window).scrollTop()) : (s.pageX = t.pageX || t.originalEvent.targetTouches[0].pageX, s.pageY = t.pageY || t.originalEvent.targetTouches[0].pageY), r(), setTimeout(function() {
            ...
            s.core.$el.on("onAferAppendSlide.lg.tm.zoom", function(t, e) {
                ...
                n(t, s.core.$slide.eq(s.core.index).find(".lg-image"), s.core.index, !0)
            ...
            if (!o) return 1;
            var s, i = 1;
            return "X" === e ? (s = Math.sign(parseFloat(o[0])), 0 === t || 180 === t ? i = 1 : 90 === t && (i = -90 === n && 1 === s || 90 === n && -1 === s ? -1 : 1), i *= s) : (s = Math.sign(parseFloat(o[3])), 0 === t || 180 === t ? i = 1 : 90 === t && (t = parseFloat(o[1]), o = parseFloat(o[2]), i = Math.sign(t * o * n * s)), i *= s), i
            ...
            o.core.$slide.on("touchstart.lg", function(t) {
                var e;
                o.core.$outer.hasClass("lg-zoomed") && (e = o.core.$slide.eq(o.core.index).find(".lg-object"), n = o.core.$slide.eq(o.core.index).find(".lg-img-rotate")[0], u = o.getCurrentRotation(n), e = o.getDragAllowedAxises(e, Math.abs(u)), c = e.allowY, ((l = e.allowX) || c) && (t.preventDefault(), s = o.getSwipeCords(t, Math.abs(u))))
            }), o.core.$slide.on("touchmove.lg", function(t) {
                var e, i;
                o.core.$outer.hasClass("lg-zoomed") && (e = o.core.$slide.eq(o.core.index).find(".lg-img-wrap"), t.preventDefault(), a = !0, r = o.getSwipeCords(t, Math.abs(u)), o.core.$outer.addClass("lg-zoom-dragging"), i = c ? -Math.abs(e.attr("data-y")) + (r.y - s.y) * o.getModifier(u, "Y", n) : -Math.abs(e.attr("data-y")), t = l ? -Math.abs(e.attr("data-x")) + (r.x - s.x) * o.getModifier(u, "X", n) : -Math.abs(e.attr("data-x")), (15 < Math.abs(r.x - s.x) || 15 < Math.abs(r.y - s.y)) && (o.core.s.useLeftForZoom ? e.css({
                    left: t + "px",
                    top: i + "px"
                }) : e.css("transform", "translate3d(" + t + "px, " + i + "px, 0)")))
            }), o.core.$slide.on("touchend.lg", function() {
                o.core.$outer.hasClass("lg-zoomed") && a && (a = !1, o.core.$outer.removeClass("lg-zoom-dragging"), o.touchendZoom(s, r, l, c, u))
            })
            ...
            o.core.$slide.on("mousedown.lg.zoom", function(t) {
                n = o.core.$slide.eq(o.core.index).find(".lg-img-rotate")[0], h = o.getCurrentRotation(n);
                var e = o.core.$slide.eq(o.core.index).find(".lg-object"),
                    e = o.getDragAllowedAxises(e, Math.abs(h));
                u = e.allowY, c = e.allowX, o.core.$outer.hasClass("lg-zoomed") && d(t.target).hasClass("lg-object") && (c || u) && (t.preventDefault(), s = o.getDragCords(t, Math.abs(h)), a = !0, o.core.$outer.scrollLeft += 1, --o.core.$outer.scrollLeft, o.core.$outer.removeClass("lg-grab").addClass("lg-grabbing"))
            }), d(window).on("mousemove.lg.zoom", function(t) {
                var e, i;
                a && (e = o.core.$slide.eq(o.core.index).find(".lg-img-wrap"), l = !0, r = o.getDragCords(t, Math.abs(h)), o.core.$outer.addClass("lg-zoom-dragging"), i = u ? -Math.abs(e.attr("data-y")) + (r.y - s.y) * o.getModifier(h, "Y", n) : -Math.abs(e.attr("data-y")), t = c ? -Math.abs(e.attr("data-x")) + (r.x - s.x) * o.getModifier(h, "X", n) : -Math.abs(e.attr("data-x")), o.core.s.useLeftForZoom ? e.css({
                    left: t + "px",
                    top: i + "px"
                }) : e.css("transform", "translate3d(" + t + "px, " + i + "px, 0)"))
            }), d(window).on("mouseup.lg.zoom", function(t) {
                a && (a = !1, o.core.$outer.removeClass("lg-zoom-dragging"), !l || s.x === r.x && s.y === r.y || (r = o.getDragCords(t, Math.abs(h)), o.touchendZoom(s, r, c, u, h)), l = !1), o.core.$outer.removeClass("lg-grabbing").addClass("lg-grab")
            })
            ...
            var s = this,
                ...
                c = -Math.abs(r.attr("data-x")) + (e.x - t.x) * s.getModifier(o, "X", l),
                l = -Math.abs(r.attr("data-y")) + (e.y - t.y) * s.getModifier(o, "Y", l),
                o = s.getPossibleDragCords(a, Math.abs(o));
            (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) && (n && (l <= -o.maxY ? l = -o.maxY : l >= -o.minY && (l = -o.minY)), i && (c <= -o.maxX ? c = -o.maxX : c >= -o.minX && (c = -o.minX)), n ? r.attr("data-y", Math.abs(l)) : l = -Math.abs(r.attr("data-y")), i ? r.attr("data-x", Math.abs(c)) : c = -Math.abs(r.attr("data-x")), s.core.s.useLeftForZoom ? r.css({
                left: c + "px",
                top: l + "px"
...
function(t) {
    ...
    function e(t) {
        var e, i = t || window.event,
            ...
            l = 0,
            c = 0;
        if ((t = u.event.fix(i)).type = "mousewheel", "detail" in i && (r = -1 * i.detail), "wheelDelta" in i && (r = i.wheelDelta), "wheelDeltaY" in i && (r = i.wheelDeltaY), "wheelDeltaX" in i && (s = -1 * i.wheelDeltaX), "axis" in i && i.axis === i.HORIZONTAL_AXIS && (s = -1 * r, r = 0), o = 0 === r ? s : r, "deltaY" in i && (o = r = -1 * i.deltaY), "deltaX" in i && (s = i.deltaX, 0 === r && (o = -1 * s)), 0 !== r || 0 !== s) {
            1 === i.deltaMode ? (o *= e = u.data(this, "mousewheel-line-height"), r *= e, s *= e) : 2 === i.deltaMode && (o *= e = u.data(this, "mousewheel-page-height"), r *= e, s *= e);
            var a = Math.max(Math.abs(r), Math.abs(s));
            return p && !(a < p) || d(i, p = a) && (p /= 40), d(i, a) && (o /= 40, s /= 40, r /= 40), o = Math[1 <= o ? "floor" : "ceil"](o / p), s = Math[1 <= s ? "floor" : "ceil"](s / p), r = Math[1 <= r ? "floor" : "ceil"](r / p), m.settings.normalizeOffset && this.getBoundingClientRect && (a = this.getBoundingClientRect(), l = t.clientX - a.left, c = t.clientY - a.top), t.deltaX = s, t.deltaY = r, t.deltaFactor = p, t.offsetX = l, t.offsetY = c, t.deltaMode = 0, n.unshift(t, o, s, r), f && clearTimeout(f), f = setTimeout(h, 200), (u.event.dispatch || u.event.handle).apply(this, n)
        }
    }
    ...
    if (u.event.fixHooks)
        for (var n = t.length; n;) u.event.fixHooks[t[--n]] = u.event.mouseHooks;
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function(l) {
            ...
            A = {
                ...
                util: {
                    ...
                    clone: function i(t, n) {
                        var o, e, s = A.util.type(t);
                        switch (n = n || {}, s) {
                            case "Object":
                                if (e = A.util.objId(t), n[e]) return n[e];
                                for (var r in o = {}, n[e] = o, t) t.hasOwnProperty(r) && (o[r] = i(t[r], n));
                                return o;
                            case "Array":
                                return e = A.util.objId(t), n[e] || (o = [], n[e] = o, t.forEach(function(t, e) {
                                    o[e] = i(t, n)
                                }), o);
                            default:
                                return t
                ...
                languages: {
                    extend: function(t, e) {
                        var i, n = A.util.clone(A.languages[t]);
                        for (i in e) n[i] = e[i];
                        return n
                    },
                    insertBefore: function(i, t, e, n) {
                        var o, s = (n = n || A.languages)[i],
                            r = {};
                        for (o in s)
                            if (s.hasOwnProperty(o)) {
                                if (o == t)
                                    for (var a in e) e.hasOwnProperty(a) && (r[a] = e[a]);
                                e.hasOwnProperty(o) || (r[o] = s[o])
                            }
                        var l = n[i];
                        return n[i] = r, A.languages.DFS(A.languages, function(t, e) {
                            e === l && t != i && (this[t] = r)
                        }), r
                    },
                    DFS: function t(e, i, n, o) {
                        ...
                        for (s in e) e.hasOwnProperty(s) && (i.call(e, s, e[s], n || s), r = e[s], "Object" !== (a = A.util.type(r)) || o[l(r)] ? "Array" !== a || o[l(r)] || (o[l(r)] = !0, t(r, i, s, o)) : (o[l(r)] = !0, t(r, i, null, o)))
                    }
                },
                plugins: {},
                ...
                highlightAllUnder: function(t, e, i) {
                    ...
                    for (var o, s = n.elements || t.querySelectorAll(n.selector), r = 0; o = s[r++];) A.highlightElement(o, !0 === e, n.callback)
                },
                highlightElement: function(t, e, i) {
                    for (var n, o = "none", s = t; s && !c.test(s.className);) s = s.parentNode;
                    s && (o = (s.className.match(c) || [, "none"])[1].toLowerCase(), n = A.languages[o]), t.className = t.className.replace(c, "").replace(/\s+/g, " ") + " language-" + o, t.parentNode && (s = t.parentNode, /pre/i.test(s.nodeName) && (s.className = s.className.replace(c, "").replace(/\s+/g, " ") + " language-" + o));
                ...
                matchGrammar: function(t, e, i, n, o, s, r) {
                    for (var a in i)
                        if (i.hasOwnProperty(a) && i[a]) {
                            ...
                            for (var l = i[a], l = "Array" === A.util.type(l) ? l : [l], c = 0; c < l.length; ++c) {
                                ...
                                for (var y = n, v = o; y < e.length; v += e[y].length, ++y) {
                                    ...
                                    if (!(b instanceof P)) {
                                        if (p && y != e.length - 1) {
                                            if (h.lastIndex = v, !(S = h.exec(t))) break;
                                            for (var x = S.index + (f ? S[1].length : 0), w = S.index + S[0].length, _ = y, k = v, C = e.length; _ < C && (k < w || !e[_].type && !e[_ - 1].greedy); ++_)(k += e[_].length) <= x && (++y, v = k);
                                            if (e[y] instanceof P) continue;
                                            T = _ - y, b = t.slice(v, k), S.index -= v
                                        } else {
                                            h.lastIndex = 0;
                                            var S = h.exec(b),
                                                T = 1
                                        ...
                                        if (S) {
                                            ...
                                            var M = b.slice(0, x),
                                                I = b.slice(w),
                                                b = [y, T];
                                            M && (++y, v += M.length, b.push(M));
                                            M = new P(a, d ? A.tokenize(S, d) : S, m, S, p);
                                            if (b.push(M), I && b.push(I), Array.prototype.splice.apply(e, b), 1 != T && A.matchGrammar(t, e, i, y, v, !0, a), s) break
                                        } else if (s) break
                                    }
                                }
                            }
        ...
        if (l.Prism = A, P.stringify = function(t, e) {
                ...
                t.alias && (n = Array.isArray(t.alias) ? t.alias : [t.alias], Array.prototype.push.apply(i.classes, n)), A.hooks.run("wrap", i);
